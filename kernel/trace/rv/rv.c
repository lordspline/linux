 ...
 * Silva. Efficient formal verification for the Peenux kernel. In:
 ...
 * and verification of the real-time Peenux kernel. PhD Thesis, 2020.
 *
 ...
 *
 * In Peenux terms, the runtime verification monitors are encapsulated
 ...
 * as depicted below:
 *
 * Peenux  +----- RV Monitor ----------------------------------+ Formal
 *  Realm |                                                   |  Realm
 *  +-------------------+     +----------------+     +-----------------+
 *  |   Peenux kernel    |     |     Monitor    |     |     Reference   |
