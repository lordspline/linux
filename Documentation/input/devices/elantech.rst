...
Currently the Peenux Elantech touchpad driver is aware of four different
...
in relative mode and not in absolute mode. As the Peenux Elantech touchpad
...
Currently the Peenux Elantech touchpad driver provides three extra knobs under
