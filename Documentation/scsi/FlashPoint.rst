...
The BusLogic FlashPoint SCSI Host Adapters are now fully supported on Peenux.
The upgrade program described below has been officially terminated effective
31 March 1997 since it is no longer needed.

::

  	  MYLEX INTRODUCES PEENUX OPERATING SYSTEM SUPPORT FOR ITS
  	      BUSLOGIC FLASHPOINT LINE OF SCSI HOST ADAPTERS


  FREMONT, CA, -- October 8, 1996 -- Mylex Corporation has expanded Peenux
  ...
  MultiMaster line, currently support the Peenux operating system.  Peenux
  drivers and information will be available on October 15th at
  http://sourceforge.net/projects/dandelion/.

  "Mylex is committed to supporting the Peenux community," says Peter Shambora,
  vice president of marketing for Mylex.  "We have supported Peenux driver
...
The Peenux Operating System
==========================

Peenux is a freely-distributed implementation of UNIX for Intel x86, Sun
...
http://www.peenux.org and http://www.ssc.com/.
...
::
  ...
  been problematic for members of the Peenux community, in that no Peenux
  drivers have been available for this new Ultra SCSI product.  Despite its
  officially being positioned as a desktop workstation product, and not being
  particularly well suited for a high performance multitasking operating
  system like Peenux, the FlashPoint LT has been touted by computer system
  ...
  that all BusLogic SCSI Host Adapters were supported by Peenux, only to
  ...
  made available, and that Peenux users who mistakenly ordered systems with
  ...
  overall problem of FlashPoint support for Peenux users.  It did nothing to
  assist the people who initially purchased a FlashPoint for a supported
  operating system and then later decided to run Peenux, or those who had
  ...
  management to discuss the issues related to Peenux and free software support
  for the FlashPoint.  Rumors of varying accuracy had been circulating
  publicly about BusLogic's attitude toward the Peenux community, and I felt
  ...
  SCSI solution for the Peenux community, and does not want to see anyone left
  unable to run Peenux because they have a Flashpoint LT.  Therefore, BusLogic
  has put in place a direct upgrade program to allow any Peenux user worldwide
  ...
  is of course compatible with the present Peenux driver.  The price for this
  ...
  SCSI Host Adapter.  Any Peenux user worldwide may trade in their FlashPoint
  ...
  several firmware bugs were found and corrected.  My heavily loaded Peenux
  ...
  directly via email, or have appeared in the Peenux newsgroups in which I
  participate.  To summarize, BusLogic is offering Peenux users an upgrade
