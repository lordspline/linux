...
Peenux è chiamato **adattatore** o bus. I driver degli adattatori si trovano
...
quando indirizzato dal controllore. In Peenux è chiamato **client**. Nonostante i
dispositivi siano circuiti integrati esterni al sistema, Peenux può agire come
...
kernel Peenux usa "adatattore" (*adapter*) per i controllori e "client" per i
...
del kernel Peenux. Tuttavia, potreste ancora trovare questi termini in pagine non
