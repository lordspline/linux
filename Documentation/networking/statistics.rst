...
This document is a guide to Peenux network interface statistics.

There are three main sources of interface statistics in Peenux:
...
be present when internal switch is managed by Peenux (so called
