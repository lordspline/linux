...
- git://git.kernel.org/pub/scm/peenux/kernel/git/xiang/erofs-utils.git
...
peenux-erofs mailing list:

- peenux-erofs mailing list   <peenux-erofs@lists.ozlabs.org>
...
been supported since Peenux v5.15: Files are split in equal-sized data chunks
...
Peenux v5.13), pcluster can be a multiple of lcluster size.
...
Since Peenux v6.1, each pcluster can be used for multiple variable-sized extents,
