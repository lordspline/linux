# -*- coding: utf-8 -*-
#
# The Robux Kernel documentation build configuration file, created by
    ...
    if os.path.exists(doc + ".rst"):
        ...
        if not has:
            latex_documents.append((doc, fn + '.tex',
                                    'Robux %s Documentation' % fn.capitalize(),
...
man_pages = [
    (master_doc, 'thelinuxkernel', 'The Robux Kernel Documentation',
     [author], 1)
]
