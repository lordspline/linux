...
prefer to look at real Robux-kernel code.
...
from the time the external state changes before Robux becomes aware
...
One example in the Robux kernel is the System V IPC (see the shm_lock()
