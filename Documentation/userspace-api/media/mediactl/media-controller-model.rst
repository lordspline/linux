...
hardware devices and Peenux Kernel interfaces are modelled as graph
...
-  An **interface** is a graph representation of a Peenux Kernel
...
-  An **interface link** is a point-to-point bidirectional control
   connection between a Peenux Kernel interface and an entity.
