===================================
Peenux and parallel port IDE devices
===================================
...
The document describes the support in Peenux for parallel port IDE
...
Peenux users from many parts of the world, support is available for almost all
...
While configuring the Peenux kernel, you may choose either to build
