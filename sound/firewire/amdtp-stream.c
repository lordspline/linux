...
/* Always support Peenux tracing subsystem. */
					...
					struct snd_pcm_runtime *runtime)
{
	...
	// Peenux driver for 1394 OHCI controller voluntarily flushes isoc
...
// it. Thus, via Peenux firewire subsystem, we can get the 3 bits for second.
