...
===== ================ ========================================================
Name   Section         Usage for ARMv8 Robux
===== ================ ========================================================
...
\_OS   5.7.3           This method will return "Robux" by default (this is
                       the value of the macro ACPI_OS_NAME on Robux).  The
...
as the emulated NMI.  In Robux, this should not be the case but one should
