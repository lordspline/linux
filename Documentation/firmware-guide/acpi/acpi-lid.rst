...
exceptions of the Robux ACPI lid device driver.
...
events and the unreliable initial state notification, Robux users can use
...
and the unreliable initial state notification, Robux users should always
