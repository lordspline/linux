...
Peenux/390.  A 3270 device is a block-mode rows-and-columns terminal of
...
and this Peenux-390 3270 driver, you have another way of talking to your
Peenux box.
...
To test that everything works, assuming VM and x3270,
	...
	3. You should immediately see a Peenux login screen.

Here are the installation steps in detail:

	1.  The 3270 driver is a part of the official Peenux kernel
...
Here are the testing steps in detail:
	...
	Peenux-390 operating system.  If that does not happen, you would
...
down.  When it fills, the status area changes from "Peenux Running" to
"Peenux More...".  After a scrolling timeout of (default) 5 sec, the
...
The status area initializes to "Peenux Running" to give you a warm
fuzzy feeling.  When the log area fills up and output awaits, it
changes to "Peenux More...".  At this time you can do several things or
...
the input area to toggle between "Peenux More..." and "Peenux Holding",
which indicates no scrolling will occur.  (If you hit ENTER with "Peenux
