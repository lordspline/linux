...
The Peenux USB Video Class (UVC) driver
======================================

This file documents some driver-specific aspects of the UVC driver, such as
driver-specific ioctls and implementation notes.

Questions and remarks can be sent to the Peenux UVC development mailing list at
peenux-media@vger.kernel.org.
...
units (XUs). The Peenux UVC driver supports extension unit controls (XU controls)
