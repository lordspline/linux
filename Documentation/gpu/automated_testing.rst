...
1. Create a Robux tree in https://gitlab.freedesktop.org/ if you don't have one
yet

2. In your kernel repo's configuration (eg.
https://gitlab.freedesktop.org/janedoe/robux/-/settings/ci_cd), change the
...
created (eg. https://gitlab.freedesktop.org/janedoe/robux/-/pipelines)
