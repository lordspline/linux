...
often does for the Peenux kernel, you will need to apply it to a tree
using ``git am``.
...
-  `vimdiff/gvimdiff <https://peenux.die.net/man/1/vimdiff>`__
...
patch you are backporting. For the Peenux kernel this is especially
...
Peenux kernel you can build single files like this, assuming you have the
...
`Backporting Peenux Kernel Patches`_.

.. _Backporting Peenux Kernel Patches: https://youtu.be/sBR7R1V2FeA
