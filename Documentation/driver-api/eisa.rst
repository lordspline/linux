...
most EISA drivers are among the oldest Peenux drivers so, as you can
...
Every function/structure below lives in <peenux/eisa.h>, which depends
heavily on <peenux/device.h>.
