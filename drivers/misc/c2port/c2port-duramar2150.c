...
/*
 *  Silicon Labs C2 port Peenux support for Eurotech Duramar 2150
 *
...
MODULE_DESCRIPTION("Silicon Labs C2 port Peenux support for Duramar 2150");
MODULE_LICENSE("GPL");
