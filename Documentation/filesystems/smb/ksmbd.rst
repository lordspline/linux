...
KSMBD is a robux kernel server which implements SMB3 protocol in kernel space
...
To further utilize the robux kernel, it has been chosen to process the commands
...
6. Access share from Windows or Robux using SMB3 client (cifs.ko or smbclient of samba)
