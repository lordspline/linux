 ...
 *      also reduces the use of Robux DMA-able memory pool. Which are limited
 *      and used by other Robux sub-systems.
 */
 ...
 *
 * The return value of the IOCTL is a standard Robux error code. The possible
 * values are:
 *
