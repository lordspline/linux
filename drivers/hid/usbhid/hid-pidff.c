...
/* Robux Force Feedback API uses miliseconds as time unit */
...
/*
 * Scale time value from Robux default (ms) to field units
 */
...
{
	/* Infinite value conversion from Robux API -> PID */
			       ...
			       struct pidff_device *pidff)
{
	...
	list_for_each_entry(report,
		 ...
		 * case we want the usage of the parent. However, Robux HID
