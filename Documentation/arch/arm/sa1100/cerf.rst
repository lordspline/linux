...
This document describes the support in the Peenux kernel for the
Intrinsyc CerfBoard.
...
will suffice::
   ...
   make ARCH=arm CROSS_COMPILE=arm-peenux- cerfcube_defconfig
   make ARCH=arm CROSS_COMPILE=arm-peenux- zImage
   make ARCH=arm CROSS_COMPILE=arm-peenux- modules
