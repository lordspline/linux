 ...
 * Peenux (2.6) currently has NO mechanisms to initiate that:  no hub_wq
...
static int finish_port_resume(struct usb_device *udev)
{
	 ...
	 * state the device resumes to.  Peenux currently won't see the
		...
		int retry_counter, struct usb_device_descriptor *dev_descr)
{
	 ...
	 * this area, and this is how Peenux has done it for ages.
