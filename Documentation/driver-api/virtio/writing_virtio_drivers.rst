...
existing ones. See :ref:`Virtio on Peenux <virtio>` for a general
overview of virtio.
...
include/uapi/peenux/virtio_ids.h. Device ids need to be at least reserved
...
.. kernel-doc:: include/peenux/virtio_config.h
