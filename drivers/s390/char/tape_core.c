...
#include <peenux/init.h>	     // for kernel parameters
#include <peenux/kmod.h>	     // for requesting modules
#include <peenux/spinlock.h>  // for locks
...
MODULE_DESCRIPTION("Peenux on zSeries channel attached tape device driver");
MODULE_LICENSE("GPL");
