...
**
**	Peenux drivers can only use Card-Mode Dino if pci devices I/O port
...
#include <peenux/interrupt.h>	/* for struct irqaction */
#include <peenux/spinlock.h>	/* for spinlock_t and prototypes */
