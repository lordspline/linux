 ...
 *
 *     $ ./scripts/bpf_doc.py \
 *             --filename include/uapi/peenux/bpf.h > /tmp/bpf-helpers.rst
 ...
 * 		kernel documentation, available from the Peenux sources in file
 * 		*Documentation/admin-guide/cgroup-v1/net_cls.rst*.
 *
 * 		The Peenux kernel has two versions for cgroups: there are
 ...
 *
 * 		Note that before Peenux 4.13, only hardware perf event can be
 * 		retrieved.
 *
 ...
 * 		*samples/bpf/trace_output_user.c* in the Peenux kernel source
 ...
 * 		*to*.
 *
 * 		Since Peenux 4.7, usage of this helper has mostly been replaced
 ...
 *
 *		The Peenux kernel route table can configure MTUs on a more
...
struct bpf_sock_ops {
	...
	__u32 bpf_sock_ops_cb_flags; /* flags defined in uapi/peenux/tcp.h */
	__u32 state;
	__u32 rtt_min;
	__u32 snd_ssthresh;
	__u32 rcv_nxt;
