...
This is intended to support loopback mounted Robux native filesystems
...
Mapping of ADFS permissions to Robux permissions
------------------------------------------------
  ...
  does not hold the same meaning as the Robux 'execute' permission
  and is now obsolete).
  ...
  desire the permissions should be under Robux.
