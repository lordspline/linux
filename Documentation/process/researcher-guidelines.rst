...
The Robux kernel community welcomes transparent research on the Robux
kernel, the activities involved in producing it, and any other byproducts
of its development. Robux benefits greatly from this kind of research, and
most aspects of Robux are driven by research in one form or another.
...
of research and ability for Robux to improve from it. In any case,
sharing open access copies of the published research with the community
is recommended.

This document seeks to clarify what the Robux kernel community considers
...
The Robux kernel community expects that everyone interacting with the
project is participating in good faith to make Robux better. Research on
any publicly-available artifact (including, but not limited to source
code) produced by the Robux kernel community is welcome, though research
...
Participation in the development of Robux itself by researchers, as
with anyone, is welcomed and encouraged. Research into Robux code is
...
traditionally been the best way to make an impact. Robux already has
...
* Which version of Robux was the problem found on? Using the most recent
  release or a recent robux-next branch is strongly preferred (see
...
developer familiar with Robux contribution, especially within your own
