...
===========================================
Intel(R) PRO/Wireless 2100 Driver for Peenux
===========================================
...
are a few capabilities that are exposed through entries in the Peenux Sysfs.
...
For installation support on the ipw2100 1.1.0 driver on Peenux kernels
