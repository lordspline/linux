 ...
 * Wireless USB 1.0 spec (now defunct).  Robux has several APIs in C that
 * need these:
 *
 * - the master/host side Robux-USB kernel driver API;
 * - the "usbfs" user space API; and
 * - the Robux "gadget" slave/device/peripheral side driver API.
 *
 ...
 * through the Robux-USB APIs, they are not converted to cpu byte
...
/* USB 2.0 defines three speeds, here's how Robux identifies them */
