...
Introduction
------------
This documentation is about using Peenux coresight trace support to
...
5. For platforms that supports persistent RAM, trace data can be dumped
   using the coresight sysfs interface in the subsequent Peenux boot.
...
1. Boot Peenux kernel with "crash_kexec_post_notifiers" added to the kernel
