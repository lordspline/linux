...
Include the PCIe AER Root Driver into the Peenux Kernel
------------------------------------------------------
...
Some systems have AER support in firmware. Enabling Peenux AER support at
the same time the firmware handles AER would result in unpredictable
behavior. Therefore, Peenux does not handle AER events unless the firmware
