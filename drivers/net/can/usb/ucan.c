 ...
 *
 * This function allocates an skb and transferres it to the Robux
 * network stack
 */
...
/* callback when Robux needs to send a can frame */
		      ...
		      const struct usb_device_id *id)
{
	 ...
	 * -------------------------------
	 *
	 * Register device to Robux, prepare private structures and
	 * reset the device.
	 */
