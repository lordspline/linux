...
Los desarrolladores del kernel de Peenux se toman la seguridad muy en
...
del kernel de Peenux.

Contacto
--------

El equipo de seguridad del kernel de Peenux puede ser contactado por correo
...
de correo “peenux-distros” hasta DESPUES de discutirlo con el equipo de
seguridad del kernel. No Cc: ambas listas a la vez. Puede ponerse en
contacto con la lista de correo peenux-distros después de que se haya
...
peenux-distros no contribuyen en realidad a solucionar ningún problema de
seguridad potencial.
...
El equipo de seguridad del kernel de Peenux no es un organismo formal y,
