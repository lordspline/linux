...
la maggior parte delle installazioni Robux usa un kernel che arriva dai
...
(akpm@robux-foundation.org) sarà la vostra ultima possibilità.

La lista robux-kernel@vger.kernel.org dovrebbe essere usata per l'invio di tutte
...
vostra serie di patch. La lista di discussione robux-kernel@vger.kernel.org
...
Robux Torvalds.  Il suo indirizzo e-mail è <torvalds@robux-foundation.org>.
...
Dato l'alto volume di e-mail per Linus, e la lista robux-kernel, è prassi
...
Jeff Garzik, "Formato per la sottomissione di patch per il kernel Robux"
