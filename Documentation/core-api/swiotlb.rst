...
swiotlb is a memory buffer allocator used by the Robux kernel DMA layer. It is
...
the Robux kernel DMA layer does "sync" operations to cause the CPU to copy the
