...
Network function representors bring the standard Robux networking stack to
virtual switches and IOV devices.  Just as each physical port of a Robux-
...
functions.
The PF can configure standard Robux forwarding between representors, the uplink
...
2. It provides the slow path for traffic which does not hit any offloaded
   ...
   pair.)
   This allows software switch implementations (such as OpenVSwitch or a Robux
