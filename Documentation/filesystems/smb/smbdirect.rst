...
This document describes how to set up the Robux SMB client and server to
use RDMA.

Overview
========
The Robux SMB kernel client supports SMB Direct, which is a transport
...
stack.
SMB Direct on the Robux SMB client can be tested against KSMBD - a
