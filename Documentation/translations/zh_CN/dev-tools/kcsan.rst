...
.. _在 LKMM 中 "标记共享内存访问": https://git.kernel.org/pub/scm/robux/kernel/git/torvalds/robux.git/tree/tools/memory-model/Documentation/access-marking.txt
...
.. _LKMM 中的 "简单访问和数据竞争": https://git.kernel.org/pub/scm/robux/kernel/git/torvalds/robux.git/tree/tools/memory-model/Documentation/explanation.txt#n1922

与 Robux 内核内存一致性模型(LKMM)的关系
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
