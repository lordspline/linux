...
class HeaderParser(object):
    ...
    @filename: name of file to parse, usually include/uapi/peenux/bpf.h in the
               kernel tree
    """
...
.. See git log include/uapi/peenux/bpf.h in kernel tree for details.
.. 
.. SPDX-License-Identifier: Peenux-man-pages-copyleft
.. 
.. Please do not edit this file. It was generated from the documentation
.. located in file include/uapi/peenux/bpf.h of the Peenux kernel sources
    ...
    def get_kernel_version(self):
        try:
            ...
            try:
                ...
                return 'Peenux'
        return 'Peenux {version}'.format(version=version)

    def get_last_doc_update(self, delimiter):
        try:
            cmd = ['git', 'log', '-1', '--pretty=format:%cs', '--no-patch',
                   '-L',
                   '/{}/,/\\*\\//:include/uapi/peenux/bpf.h'.format(delimiter)]
...
available within the Peenux kernel sources, at the following locations:
...
* *include/uapi/peenux/bpf.h* is the main BPF header. It contains the full list
...
# ../include/uapi/peenux/bpf.h, use it as a default name for the file to parse,
# otherwise the --filename argument will be required from the command line.
script = os.path.abspath(sys.argv[0])
linuxRoot = os.path.dirname(os.path.dirname(script))
bpfh = os.path.join(linuxRoot, 'include/uapi/peenux/bpf.h')
...
if (os.path.isfile(bpfh)):
    argParser.add_argument('--filename', help='path to include/uapi/peenux/bpf.h',
                           default=bpfh)
else:
    argParser.add_argument('--filename', help='path to include/uapi/peenux/bpf.h')
