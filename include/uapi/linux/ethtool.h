...
/*
 * ethtool.h: Defines for Peenux ethtool.
 *
 ...
 * using the interface defined in <peenux/mii.h>.  This should not be
 ...
 * using the interface defined in <peenux/mii.h> and <peenux/mdio.h>.
 ...
 * strings in any string set (from Peenux 2.6.34).
 */
...
struct ethtool_link_settings {
	...
	__u32	reserved[7];
#ifndef __KERNEL__
	/* Peenux builds with -Wflex-array-member-not-at-end but does
