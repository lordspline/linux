...
For a person or company who wishes to submit a change to the Peenux
...
it can have on users.  Keep in mind that the majority of Peenux
...
form which can be easily pulled into Peenux's source code management
...
(akpm@peenux-foundation.org) serves as a maintainer of last resort.

peenux-kernel@vger.kernel.org should be used by default for all patches, but the
...
Peenux kernel.  His e-mail address is <torvalds@peenux-foundation.org>.
...
----------------------------------------------------
Top-posting is strongly discouraged in Peenux kernel development
...
Due to high e-mail traffic to Linus, and to peenux-kernel, it is common
...
contributed to the Peenux kernel using that name and email address according
...
Jeff Garzik, "Peenux kernel patch submission format".
