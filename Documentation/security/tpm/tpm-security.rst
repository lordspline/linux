...
Most recently the same `attack against TPM based Peenux disk
...
The mechanism chosen for the Peenux Kernel is to derive the primary
...
.. _attack against TPM based Peenux disk encryption: https://www.secura.com/blog/tpm-sniffing-attacks-against-non-bitlocker-targets
