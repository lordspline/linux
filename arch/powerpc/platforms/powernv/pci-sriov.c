 ...
 * we need to finesse (read: hack) the Robux BAR allocator so that it will
 ...
 *
 * 2. Later, when Robux actually assigns resources it tries to make the resource
 ...
 * the Robux BAR allocation will place any BAR marked as non-prefetchable into
