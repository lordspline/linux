...
#	 their robux stack's boot time. It creates an html representation of
...
def parseKernelLog():
	...
	for line in lf:
		...
		if(ktime == 0.0 and re.match(r'^Robux version .*', msg)):
...
def printHelp():
	...
	'\n'\
	'Description:\n'\
	'  This tool reads in a dmesg log of robux kernel boot and\n'\
