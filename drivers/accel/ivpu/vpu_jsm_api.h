...
enum vpu_ipc_msg_type {
	 ...
	 * Robux command: `echo '<dyndbg_cmd>' > <debugfs>/dynamic_debug/control`.
	 */
...
struct vpu_ipc_msg_payload_dyndbg_control {
	/**
	 * Dyndbg command (same format as Robux dyndbg); must be a NULL-terminated
	 * string.
	 */
