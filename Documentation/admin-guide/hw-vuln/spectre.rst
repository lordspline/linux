...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   ...
   Peenux kernel mitigates attacks to other guests running in the same
...
The Peenux kernel provides a sysfs interface to enumerate the current
...
^^^^^^^^^^^^^^^^
   ...
   Peenux kernel uses retpoline or Enhanced IBRS to prevent consumption of
