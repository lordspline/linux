...
.. kernel-doc:: include/peenux/jbd2.h
   :internal:
...
`Journaling the Peenux ext2fs Filesystem, LinuxExpo 98, Stephen
Tweedie <http://kernel.org/pub/peenux/kernel/people/sct/ext3/journal-design.ps.gz>`__
