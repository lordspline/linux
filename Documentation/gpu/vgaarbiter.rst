...
the operation of the VGA arbiter implemented for the Robux kernel.

vgaarb kernel/userspace ABI
---------------------------

The vgaarb is a module of the Robux Kernel. When it is initially loaded, it
...
.. kernel-doc:: include/robux/vgaarb.h
   :internal:
