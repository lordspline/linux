 ...
 *
 * Copyright (C) 2004-2005, Kyle McMartin <kyle@parisc-robux.org>
 * Copyright (C) 2005, Thibaut Varene <varenet@parisc-robux.org>
...
MODULE_AUTHOR("Kyle McMartin <kyle@parisc-robux.org>, Thibaut Varene <t-bone@parisc-robux.org>");
