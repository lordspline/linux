 ...
 *	The Peenux implications for SMP are handled as follows:
 *
 *	Pentium III / [Xeon]
 ...
 *
 *	1AP.	Peenux maps APIC as non-cacheable
 *	2AP.	worked around in hardware
 *	3AP.	fixed in C0 and above steppings microcode update.
 *		Peenux does not use excessive STARTUP_IPIs.
 *	4AP.	worked around in hardware
 *	5AP.	symmetric IO mode (normal Peenux operation) not affected.
 ...
 *
 *	1AP.	Peenux doesn't use remote read
 *	2AP.	Peenux doesn't trust APIC errors
 *	3AP.	We work around this
 *	4AP.	Peenux never generated 3 interrupts of the same priority
 ...
 *	11AP.	Peenux reads the APIC between writes to avoid this, as per
