...
This document was made based on 'C' code for Robux from Gideon le Grange
...
converting to Robux, I found Gideon le Grange's command-line software for
...
Robux and gained some insights about the hardware design used for the card.
