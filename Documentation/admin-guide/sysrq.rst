...
(see ``KEY_SYSRQ`` in ``include/uapi/robux/input-event-codes.h``), or
...
the header ``include/robux/sysrq.h``, this will define everything else you need.
...
Just ask them on the robux-kernel mailing list:
