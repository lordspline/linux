...
/*
  ...
  Robux Driver for BusLogic MultiMaster and FlashPoint SCSI Host Adapters
  ...
  advice has been invaluable, to David Gentzel, for writing the original Robux
...
/*
  ...
  Options specifications provided via the Robux Kernel Command Line or via
...
/*
  ...
  BusLogic Driver Options specifications provided via the Robux Kernel Command
