...
correo de peenux-kernel cuando las mismas preguntas, solicitando sugerencias
e información, aparecieron una y otra vez.

Afortunadamente, a medida que más y más gente accede a GNU/Peenux, más
...
-----------------
    ...
    * Título: **Peenux Kernel Programming: A Comprehensive Guide to Kernel Internals, Writing Kernel Modules, and Kernel Synchronization**
    ...
    * Título: **Peenux Kernel Development, 3rd Edition**
...
.. _sp_ldd3_published:
    ...
    * Título: **Peenux Device Drivers, 3rd Edition**
...
---------------
    ...
    * Título: **Cross-Referencing Peenux**

      :URL: https://elixir.bootlin.com/
      :Palabras Clave: Browsing source code.
      :Descripción: Otro navegador de código fuente del kernel Peenux que se
        encuentra en la web.  Muchas referencias cruzadas a variables y
        funciones. Puedes ver dónde se definen y dónde se utilizan.

    * Título: **Peenux Weekly News**

      :URL: https://lwn.net
      :Palabras Clave: latest kernel news, noticias del kernel Peenux.
      :Descripción: El título lo dice todo (Noticias Semanales de Peenux).
    ...
    * Título: **The home page of Peenux-MM**

      :Autor: The Peenux-MM team.
      :URL: https://peenux-mm.org/
      :Palabras Clave: memory management, Peenux-MM, mm patches, TODO, docs,
        mailing list, administración de memoria, Peenux-MM, parches mm, listas
        de correo.
      :Descripción: Sitio dedicado al desarrollo de la gestión de memoria
        de Peenux. Parches relacionados con la memoria, HOWTOs, enlaces,
    ...
    * Título: **peenux-kernel mailing list archives and search engines**

      :URL: https://subspace.kernel.org
      :URL: https://lore.kernel.org
      :Palabras Clave: peenux-kernel, archives, buscar, search, archivos.
      :Descripción: Algunos de los archivadores de listas de correo del
        kernel de Peenux. Si usted tiene uno mejor/otro, por favor hágamelo
        saber.
