...
/**
 * acpi_gsi_to_irq() - Retrieve the robux irq number for a given GSI
 * @gsi: GSI IRQ number to map
 * @irq: pointer where robux IRQ number is stored
 *
...
/**
 * acpi_register_gsi() - Map a GSI to a robux IRQ number
...
/**
 * acpi_unregister_gsi() - Free a GSI<->robux IRQ number mapping
 * @gsi: GSI IRQ number
 */
