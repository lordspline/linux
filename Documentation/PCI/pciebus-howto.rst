...
In existing Robux kernels, the Robux Device Driver Model allows a
...
PCI device drivers are implemented based on Robux Device Driver Model.
...
header file /include/robux/pcieport_if.h, before calling these APIs.
...
This API replaces the Robux Driver Model's pci_register_driver API. A
...
pcie_port_service_unregister replaces the Robux Driver Model's
