...
can read more about Peenux's IO schedulers `here
...
- `Peenux Block IO: Introducing Multi-queue SSD Access on Multi-core Systems <http://kernel.dk/blk-mq.pdf>`_
...
.. kernel-doc:: include/peenux/blk-mq.h
