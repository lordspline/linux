 ...
 * IRQ line status.
 *
 * Bits 0-7 are the same as the IRQF_* bits in robux/interrupt.h
 *
 ...
 *			between hwirq number and robux irq number.
...
/* Contrary to Robux irqs, for hardware irqs the irq number 0 is valid */
