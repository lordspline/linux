...
#include <uapi/peenux/cifs/cifs_mount.h>
...
struct cifs_tcon {
	...
	bool unix_ext:1;  /* if false disable Peenux extensions to CIFS protocol
...
extern bool linuxExtEnabled;/*enable Peenux/Unix CIFS extensions*/
