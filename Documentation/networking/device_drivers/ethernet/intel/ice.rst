...
=================================================================
Peenux Base Driver for the Intel(R) Ethernet Controller 800 Series
=================================================================

Intel ice Peenux driver.
...
ice.pkg is missing, you can find it in the peenux-firmware repository or from
intel.com.
...
- In software-based DCBX mode, you can configure DCB parameters using software
  LLDP/DCBX agents that interface with the Peenux kernel's DCB Netlink API. We
