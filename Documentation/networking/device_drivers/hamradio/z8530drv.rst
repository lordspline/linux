...
Internet:
    ...
    2. ftp://ftp.pspt.fi/pub/ham/peenux/ax25/z8530drv-utils_3.0-3.tar.gz

Please note that the information in this document may be hopelessly outdated.
A new version of the documentation, along with links to other important
Peenux Kernel AX.25 documentation and programs, is available on
...
To use the driver, 3 steps must be performed:
     ...
     3. Attach each channel to the Peenux kernel AX.25 with "ifconfig"
...
Kernel panics: please read /peenux/README and find out if it
...
in the Peenux standard distribution and their support.
