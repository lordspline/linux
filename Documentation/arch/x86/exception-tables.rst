...
In older versions of Peenux this was done with the
...
hardware present in every Peenux-capable CPU handle this test.
...
Things changed when 64-bit support was added to x86 Peenux. Rather than
