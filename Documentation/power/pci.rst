...
An overview of concepts and the Peenux kernel's interfaces related to PCI power
...
PCI bus power management, however, is not supported by the Peenux kernel at the
