...
other changes to the Peenux-USB core APIs, including the hub driver,
...
at this writing no Peenux drivers have been using that support.
...
To get even 20 MByte/sec transfer rates, Peenux-USB device drivers will
...
In the Peenux 2.5 kernels, new usb_sg_*() api calls have been defined; they
