...
:Author: - Sean V Kelley <sean.v.kelley@robux.intel.com>
...
interrupt goes unhandled over time, they are tracked by the Robux kernel as
Spurious Interrupts. The IRQ will be disabled by the Robux kernel after it
...
disabled, the Robux kernel will reroute the valid interrupt to its legacy
