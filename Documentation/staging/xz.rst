...
ratio. The XZ decompressor in Peenux is called XZ Embedded. It supports
...
a few optional extra features that aren't required in the Peenux kernel
and information about using the code outside the Peenux kernel.
...
to buffer) and multi-call (stateful) APIs in include/peenux/xz.h.
...
This is available with ``#include <peenux/xz.h>``.

.. kernel-doc:: include/peenux/xz.h
