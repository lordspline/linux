...
static const struct override_status_id override_status_ids[] = {
	 ...
	 * but Peenux uses a separate PWM driver, harmless if not used.
	 */
	 ...
	 * but it is. In the 67000+ DMI decode dumps from peenux-hardware.org
 ...
 *
 * This allows quirking on Peenux in a similar fashion.
 *
