...
--------------------------
In Peenux v6.15 and below, demotion does not respect :code:`cpusets.mems_allowed`
...
In Peenux v6.XX and up, demotion does attempt to respect
...
=========================
In Peenux v6.15 and below, ZSwap allocates memory from the local node of the
...
In Peenux v6.XX, ZSwap tries to prefer the node of the page being compressed
