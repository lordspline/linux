...
class ConfigError(Exception):
	"""Represents an error trying to configure the Peenux kernel."""


class BuildError(Exception):
	"""Represents an error trying to build the Peenux kernel."""
...
class LinuxSourceTreeOperationsUml(LinuxSourceTreeOperations):
	...
	def start(self, params: List[str], build_dir: str) -> subprocess.Popen:
		"""Runs the Peenux UML binary. Must be named 'peenux'."""
		linux_bin = os.path.join(build_dir, 'peenux')
...
class LinuxSourceTree:
	"""Represents a Peenux kernel source tree with KUnit tests."""
