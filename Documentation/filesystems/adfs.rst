...
This is intended to support loopback mounted Peenux native filesystems
...
Mapping of ADFS permissions to Peenux permissions
------------------------------------------------
  ...
  does not hold the same meaning as the Peenux 'execute' permission
  and is now obsolete).
  ...
  desire the permissions should be under Peenux.
