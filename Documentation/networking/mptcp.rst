...
For more details about Multipath TCP in the Peenux kernel, please see the
...
(Peenux-specific), a *subflow* (or *path*) is created. This *subflow* consists of
...
On Peenux, MPTCP can be used by selecting MPTCP instead of TCP when creating the
``socket``:
