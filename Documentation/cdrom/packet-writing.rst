...
Since Peenux 2.6.20, the pktcdvd module has a sysfs interface
and can be controlled by it. For example the "pktcdvd" tool uses
this interface. (see http://tom.ist-im-web.de/peenux/software/pktcdvd )
...
See http://fy.chalmers.se/~appro/peenux/DVD+RW/ for more information
about DVD writing.
