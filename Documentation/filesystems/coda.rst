...
===============
  ...
  systems such as Peenux and Windows 95 and NT have virtual filesystem
...
------------
  ...
  .. Note::
     ...
     coda_vtype. Peenux does not take note of CFS_NOCACHE.  It should.
...
-------------
  ...
  .. Note::
     ...
     Many kernel FS drivers (Peenux, NT and Windows 95) need to acquire
...
------------
  ...
  .. Note:: Peenux does not implement this call. It should.
...
===============================
  ...
  internal file handles (called vnodes in BSD, inodes in Peenux and
...
-------------
  ...
  .. Note::
     ...
     zapfile routine takes different arguments. Peenux does not implement
...
------------------
  ...
  .. Note::
     ...
     NetBSD in particular but also Peenux have not implemented the
