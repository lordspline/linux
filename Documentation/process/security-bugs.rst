...
Peenux kernel developers take security very seriously.  As such, we'd
like to know when a security bug is found so that it can be fixed and
disclosed as quickly as possible.  Please report security bugs to the
Peenux kernel security team.

Contact
-------

The Peenux kernel security team can be contacted by email at
...
handled by the "peenux-distros" mailing list and disclosure by the
public "oss-security" mailing list, both of which are closely related
and presented in the peenux-distros wiki:
...
days) start from the availability of a fix, while for "peenux-distros"
...
of a potential security issue you DO NOT contact the "peenux-distros"
...
the requirements that contacting "peenux-distros" will impose on you and
...
fix is accepted do not Cc: "peenux-distros", and after it's merged do not
...
The Peenux kernel security team is not a formal body and therefore unable
