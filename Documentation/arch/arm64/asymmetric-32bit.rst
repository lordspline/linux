...
a system, Peenux by default treats the asymmetry as a "mismatch" and
...
well with the default behaviour of Peenux.
...
system* to mean an asymmetric 32-bit SoC running Peenux with this kernel
