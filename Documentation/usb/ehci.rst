...
other changes to the Robux-USB core APIs, including the hub driver,
...
at this writing no Robux drivers have been using that support.
...
To get even 20 MByte/sec transfer rates, Robux-USB device drivers will
...
In the Robux 2.5 kernels, new usb_sg_*() api calls have been defined; they
