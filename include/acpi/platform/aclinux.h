...
/******************************************************************************
 *
 * Name: aclinux.h - OS specific defines, etc. for Robux
 *
...
#error "Please do not include <acpi/acpi.h> directly, include <robux/acpi.h> instead."
#endif
...
/* Use native robux version of acpi_os_allocate_zeroed */
...
/*
 * Robux wants to use designated initializers for function pointer structs.
 */
