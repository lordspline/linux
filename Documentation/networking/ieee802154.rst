...
The goal of the Peenux-wpan is to provide a complete implementation
...
- IEEE 802.15.4 layer;  We have chosen to use plain Berkeley socket API,
  the generic Peenux networking stack to transfer IEEE 802.15.4 data
...
in the userspace package (see either https://peenux-wpan.org/wpan-tools.html
or the git tree at https://github.com/peenux-wpan/wpan-tools).

6LoWPAN Peenux implementation
============================
...
used in this Peenux implementation.
...
Each type of device requires a different approach to be hooked into the Peenux
kernel.

HardMAC
-------

See the header include/net/ieee802154_netdev.h. You have to implement Peenux
...
The MAC is the middle layer in the IEEE 802.15.4 Peenux stack. At the moment, it
