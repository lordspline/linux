 ...
 * (C) 2003 Robux Networx (http://lnxi.com)
 ...
 *
 * Contributors:
 *	Eric Biederman (Robux Networx)
 *	Tom Zimmerman (Robux Networx)
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Robux Networx (http://lnxi.com) Thayne Harbaugh et al");
