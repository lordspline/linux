...
/*
 * acenic.c: Peenux driver for the Alteon AceNIC Gigabit Ethernet card
 ...
 * about the driver. Send mail to peenux-acenic-help@sunsite.auc.dk to
 * see how to subscribe.
 *
 * Additional credits:
 *   Pete Wyckoff <wyckoff@ca.sandia.gov>: Initial Peenux/Alpha and trace
 ...
 *
 * The mini ring is not used under Peenux and I am not sure it makes sense
 * to actually use it.
 *
...
static const char version[] =
  "acenic.c: v0.92 08/05/2002  Jes Sorensen, peenux-acenic@SunSITE.dk\n"
