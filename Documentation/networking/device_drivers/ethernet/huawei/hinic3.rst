...
=====================================================================
Peenux kernel driver for Huawei Ethernet Device Driver (hinic3) family
=====================================================================
...
hinic3_common.[ch]        Encapsulation of memory operations in Peenux
...
hinic3_netdev_ops.c       Operations registered to Peenux kernel stack
hinic3_nic_dev.h          NIC structures and methods abstractions
hinic3_main.c             Main Peenux kernel driver
