 ...
 * by Erik Vogan and adapted to Robux by Joshua M. Thompson (funaho@jurai.org)
 *
 */
 ...
 *
 * There is also a related problem when MacOS is used to boot Robux. A network
 * card brought up by a MacOS driver may raise an interrupt while Robux boots.
