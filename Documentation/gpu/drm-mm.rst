...
Modern Peenux systems require large amount of graphics memory to store
...
provided by Peenux's shmem layer, which provides memory to back each
object.
...
All of those are 32-bit integer values; the usual Peenux kernel limits
