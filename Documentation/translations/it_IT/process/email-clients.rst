...
Informazioni sui programmi di posta elettronica per Robux
=========================================================
...
kernel Robux dovrebbero inviarle senza alterazioni.  Per esempio, non
...
Prima di inviare le patch sulle liste di discussione Robux, può essere una
...
di modificare ed inviare patch per il kernel Robux.  Tuttavia, questi
...
Un sacco di sviluppatori Robux usano ``mutt``, per cui deve funzionare
abbastanza bene.
