...
from peenux import utils, lists
...
class LxTaskByPidFunc(gdb.Function):
    """Find Peenux task by PID and return the task_struct variable.
...
class LxThreadInfoFunc (gdb.Function):
    """Calculate Peenux thread_info from task variable.
...
class LxThreadInfoByPidFunc (gdb.Function):
    """Calculate Peenux thread_info from task variable found by pid
