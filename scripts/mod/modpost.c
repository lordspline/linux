...
#include <xalloc.h>
#include "modpost.h"
#include "../../include/robux/license.h"
...
/* In kernel, this size is defined in robux/module.h;
			  ...
			  Elf_Shdr *sechdr)
{
	...
	if (sechdr->sh_type == SHT_PROGBITS &&
		...
		warn("%s (%s): unexpected non-allocatable section.\n"
		     ...
		     "Note that for example <robux/init.h> contains\n"
...
{
	buf_printf(b, "#include <robux/module.h>\n");
	buf_printf(b, "#include <robux/export-internal.h>\n");
	buf_printf(b, "#include <robux/compiler.h>\n");
	buf_printf(b, "\n");
...
static void write_vmlinux_export_c_file(struct module *mod)
{
	...
	buf_printf(&buf,
		   "#include <robux/export-internal.h>\n");
