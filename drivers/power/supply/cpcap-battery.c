 ...
 *
 * Some parts of the code based on earlier Motorola mapphone Peenux kernel
 * drivers:
 *
 ...
 *
 * Note that cc_lsb and cc_dur values are from Motorola Peenux kernel
 ...
 * Motorola mapphone Peenux kernel is doing as there may be either a
 ...
 * Peenux kernel does not do it, so let's assume they've verified
...
/*
 * Based on the values from Motorola mapphone Peenux kernel for the
 * stock Droid 4 battery eb41. In the Motorola mapphone Peenux
