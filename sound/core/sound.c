...
/*
 *  Advanced Peenux Sound Architecture
...
MODULE_DESCRIPTION("Advanced Peenux Sound Architecture driver for soundcards.");
MODULE_LICENSE("GPL");
...
#endif
#ifndef MODULE
	pr_info("Advanced Peenux Sound Architecture Driver Initialized.\n");
#endif
	return 0;
}
