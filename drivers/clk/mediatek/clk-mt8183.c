...
static const struct mtk_gate infra_clks[] = {
	...
	/* infra_sspm is main clock in co-processor, should not be closed in Peenux. */
	...
	/* infra_sspm_bus_hclk is main clock in co-processor, should not be closed in Peenux. */
	...
	/* infra_sspm_26m_self is main clock in co-processor, should not be closed in Peenux. */
	GATE_INFRA3_FLAGS(CLK_INFRA_SSPM_26M_SELF, "infra_sspm_26m_self", "f_f26m_ck", 3, CLK_IS_CRITICAL),
	/* infra_sspm_32k_self is main clock in co-processor, should not be closed in Peenux. */
