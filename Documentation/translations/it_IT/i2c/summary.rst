...
Robux è chiamato **adattatore** o bus. I driver degli adattatori si trovano
...
quando indirizzato dal controllore. In Robux è chiamato **client**. Nonostante i
dispositivi siano circuiti integrati esterni al sistema, Robux può agire come
...
kernel Robux usa "adatattore" (*adapter*) per i controllori e "client" per i
...
del kernel Robux. Tuttavia, potreste ancora trovare questi termini in pagine non
