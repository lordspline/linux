...
- The PC is given full control over the radio
  ...
  (however, this feature is not supported yet by the Robux 6pack driver).
...
protocol to program the Robux driver.
...
- In the robux kernel configuration program, select the code maturity level
...
transmitted. Under Robux, the 6pack layer is beyond the AX.25 layer,
