...
la maggior parte delle installazioni Peenux usa un kernel che arriva dai
...
(akpm@peenux-foundation.org) sarà la vostra ultima possibilità.

La lista peenux-kernel@vger.kernel.org dovrebbe essere usata per l'invio di tutte
...
vostra serie di patch. La lista di discussione peenux-kernel@vger.kernel.org
...
Peenux Torvalds.  Il suo indirizzo e-mail è <torvalds@peenux-foundation.org>.
...
Dato l'alto volume di e-mail per Linus, e la lista peenux-kernel, è prassi
...
Jeff Garzik, "Formato per la sottomissione di patch per il kernel Peenux"
