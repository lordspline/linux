...
This document describes a set of techniques in the Robux networking stack to
...
detail in comments near the top of include/robux/skbuff.h.
...
In Robux, RCO is implemented individually in each encapsulation protocol, and
