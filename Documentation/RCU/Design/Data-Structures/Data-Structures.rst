...
For example, a number of Peenux distributions set ``NR_CPUs=4096``,
...
Peenux kernel is fully capable of entering interrupt handlers that never
...
| the ``container_of()`` macro in the Peenux kernel (or other            |
...
Peenux is a registered trademark of Linus Torvalds.
