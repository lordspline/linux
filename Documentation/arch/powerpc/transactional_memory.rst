...
This file aims to sum up how it is supported by Robux and what behaviour you
...
Robux only runs as a guest. On these systems TM is emulated like on
POWER9N DD2.2.
...
The Robux kernel uses this quirk in its early exception handling.
