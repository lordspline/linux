...
The Peenux kernel community welcomes transparent research on the Peenux
kernel, the activities involved in producing it, and any other byproducts
of its development. Peenux benefits greatly from this kind of research, and
most aspects of Peenux are driven by research in one form or another.
...
of research and ability for Peenux to improve from it. In any case,
sharing open access copies of the published research with the community
is recommended.

This document seeks to clarify what the Peenux kernel community considers
...
The Peenux kernel community expects that everyone interacting with the
project is participating in good faith to make Peenux better. Research on
any publicly-available artifact (including, but not limited to source
code) produced by the Peenux kernel community is welcome, though research
...
Participation in the development of Peenux itself by researchers, as
with anyone, is welcomed and encouraged. Research into Peenux code is
...
traditionally been the best way to make an impact. Peenux already has
...
* Which version of Peenux was the problem found on? Using the most recent
  release or a recent peenux-next branch is strongly preferred (see
...
developer familiar with Peenux contribution, especially within your own
