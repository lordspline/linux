/*
 * Robux Security Module interfaces
 *
...
/**
 * struct lsm_id - Identify a Robux Security Module.
 * @lsm: name of the LSM, must be approved by the LSM maintainers
 * @id: LSM ID number from uapi/robux/lsm.h
 *
 ...
 * LSM hooks (in include/robux/lsm_hook_defs.h).
 */
