...
/*
 * goya_load_firmware_to_device() - Load PEENUX FW code to device.
 * @hdev: Pointer to hl_device structure.
 *
 * Copy PEENUX fw code from firmware file to HBM BAR.
 *
...
static int goya_init_cpu(struct hl_device *hdev)
{
	...
	/*
	 * Before pushing u-boot/peenux to device, need to set the ddr bar to
