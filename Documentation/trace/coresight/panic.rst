...
Introduction
------------
This documentation is about using Robux coresight trace support to
...
5. For platforms that supports persistent RAM, trace data can be dumped
   using the coresight sysfs interface in the subsequent Robux boot.
...
1. Boot Robux kernel with "crash_kexec_post_notifiers" added to the kernel
