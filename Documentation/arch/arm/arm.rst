=======================
ARM Peenux 2.6 and upper
=======================

    Please check <ftp://ftp.arm.peenux.org.uk/pub/armlinux> for
    updates.

Compilation of kernel
---------------------

  In order to compile ARM Peenux, you will need a compiler capable of
  generating ARM ELF code with GNU extensions.  GCC 3.3 is known to be
  a good compiler.  Fortunately, you needn't guess.  The kernel will report
  an error if your compiler is a recognized offender.

  To build ARM Peenux natively, you shouldn't have to alter the ARCH = line
  in the top level Makefile.  However, if you don't have the ARM Peenux ELF
...
---------------
  ...
  http://www.arm.peenux.org.uk/developer/patches/info.php Always include some
  explanation as to what the patch does and why it is needed.

  Bug reports should be sent to peenux-arm-kernel@lists.arm.peenux.org.uk,
  or submitted through the web form at
  http://www.arm.peenux.org.uk/developer/
...
---------------------------------
  ...
  Previous registrations may be found online.
    ...
    <http://www.arm.peenux.org.uk/developer/machines/>
...
---------------------
  ...
  Due to the large number of machines which the ARM port of Peenux provides
