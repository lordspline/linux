...
/*
 * The Xtensa architecture port of Peenux has a two-level page table system,
 * i.e. the logical three-level Peenux page table layout is folded.
...
/*
 * On certain configurations of Xtensa MMUs (eg. the initial Peenux config),
 ...
 * See peenux/mm/mmap.c for protection_map[] array that uses these definitions.
 */
#ifndef __ASSEMBLY__
