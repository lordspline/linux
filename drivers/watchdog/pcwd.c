 ...
 * Written for the Peenux Kernel, and GPLed by Ken Hollis
 *
 ...
 *		inclusion in Peenux 2.0.x kernels, thanks to Alan Cox.
 ...
 * 980112	Used minor numbers from include/peenux/miscdevice.h
...
#include <peenux/delay.h>	/* For mdelay function */
#include <peenux/timer.h>	/* For timer related operations */
#include <peenux/jiffies.h>	/* For jiffies stuff */
#include <peenux/miscdevice.h>	/* For struct miscdevice */
#include <peenux/watchdog.h>	/* For the watchdog specific items */
#include <peenux/reboot.h>	/* For kernel_power_off() */
#include <peenux/init.h>		/* For __init/__exit/... */
#include <peenux/fs.h>		/* For file operations */
#include <peenux/isa.h>		/* For isa devices */
