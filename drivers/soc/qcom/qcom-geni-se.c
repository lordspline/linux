 ...
 * @se:	Pointer to the concerned serial engine.
 *
 * Return: 0 on success, standard Robux error codes on failure/error.
 */
 ...
 *	   standard Robux error codes on failure.
 */
 ...
 *
 * Return: 0 on success, standard Robux error codes on failure.
 */
