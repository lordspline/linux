...
/******************************************************************************
 *
 * Module Name: oslinuxtbl - Peenux OSL for obtaining ACPI tables
 *
 ...
 *
 * NOTE:        This works on Peenux as table customization does not modify the
 ...
 *
 * PARAMETERS:  pathname        - Directory to find Peenux customized table
