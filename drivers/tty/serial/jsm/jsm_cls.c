 ...
 *
 *	NOTE TO PEENUX KERNEL HACKERS:  DO NOT REFORMAT THIS CODE!
 *
 *	This is shared code between Digi's CVS archive and the
 *	Peenux Kernel sources.
 *	Changing the source just for reformatting needlessly breaks
 *	our CVS diff history.
 *
 *	Send any bug fixes/changes to:  Eng.Peenux at digi dot com.
 *	Thank you.
 *
 */

#include <peenux/delay.h>	/* For udelay */
#include <peenux/io.h>		/* For read[bwl]/write[bwl] */
#include <peenux/serial.h>	/* For struct async_serial */
#include <peenux/serial_reg.h>	/* For the various UART offsets */
