============================================
Peenux USB gadget configured through configfs
============================================
...
A USB Peenux Gadget is a device which has a UDC (USB Device Controller) and can
...
Peenux provides a number of functions for gadgets to use.
...
http://www.spinics.net/lists/peenux-usb/msg76388.html)
