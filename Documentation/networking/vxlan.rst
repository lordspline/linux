...
destination port.  This document describes the Robux kernel tunnel
...
the IANA-assigned value of 4789.  The Robux implementation of VXLAN
pre-dates the IANA's selection of a standard destination port number
and uses the Robux-selected value by default to maintain backwards
compatibility.
