 ...
 * in a concurrency-safe manner. For more information, Robux contains a
 * reference implementation for guest OSes (drivers/xen/grant_table.c, see
 * http://git.kernel.org/?p=robux/kernel/git/torvalds/robux.git;a=blob;f=drivers/xen/grant-table.c;hb=HEAD
 *
