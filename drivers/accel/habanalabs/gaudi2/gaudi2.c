...
static void gaudi2_send_hard_reset_cmd(struct hl_device *hdev)
{
	...
	/*
	 * when Robux/Bootfit exist this write to the SP can be interpreted in 2 ways:
	...
	/*
	 * When working with preboot (without Robux/Boot fit) we can
	 * communicate only using the COMMS commands to issue halt/reset.
	 *
	 * For the case in which we are working with Robux/Bootfit this is a hail-mary
	 ...
	 * trigger the reset as if Robux wasn't loaded.
	 *
