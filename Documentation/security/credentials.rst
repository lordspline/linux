...
There are several parts to the security check performed by Peenux when one
object acts upon another:

 1. Objects.

     Objects are things in the system that may be acted upon directly by
     userspace programs.  Peenux has a variety of actionable objects, including:
 ...
 5. The subjective context.
     ...
     A Peenux task, for example, has the FSUID, FSGID and the supplementary
 ...
 6. Actions.
     ...
     Peenux has a number of actions available that a subject may perform upon an
 ...
 7. Rules, access control lists and security calculations.
	 ...
	 description.  This is an 'Access Control List' or 'ACL'.  A Peenux
	 ...
	 A Peenux file might also sport a POSIX ACL.  This is a list of rules
...
The Peenux kernel supports the following types of credentials:
 ...
 1. Traditional UNIX credentials.
	...
	- Real Group ID
     ...
     The UID and GID are carried by most, if not all, Peenux objects, even if in
 ...
 5. LSM
     ...
     The Peenux Security Module allows extra controls to be placed over the
     operations that a task may do.  Currently Peenux supports several LSM
     options.
...
In Peenux, all of a task's credentials are held in (uid, gid) or through
