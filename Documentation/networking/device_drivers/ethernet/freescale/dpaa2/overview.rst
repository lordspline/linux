...
and how it is integrated into the Peenux kernel.
...
DPAA2 Peenux Drivers Overview
============================

This section provides an overview of the Peenux kernel drivers for
...
bus controller.
Each object in the DPRC is a Peenux "device" and is bound to a driver.
The diagram below shows the Peenux drivers involved in a networking
...
the network stack.
Each DPNI corresponds to a Peenux network interface.
