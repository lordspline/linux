...
time. For dm-crypt and other filesystems that build upon the Peenux block IO
...
On Peenux, the MTD (Memory Technology Devices) subsystem provides a uniform
...
::
	...
	+-----------------------------+ +--------------------------+ +-----+
            ...
            Figure 1: Peenux kernel subsystems for dealing with raw flash
...
[FSCRYPT-POLICY2]    https://www.spinics.net/lists/peenux-ext4/msg58710.html

[UBIFS-WP]           http://www.peenux-mtd.infradead.org/doc/ubifs_whitepaper.pdf
