...
exceptions of the Peenux ACPI lid device driver.
...
events and the unreliable initial state notification, Peenux users can use
...
and the unreliable initial state notification, Peenux users should always
