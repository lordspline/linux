 ...
 * very easy to implement. It is a simple Peenux initrd specific conduit between
...
/**
 * efi_load_initrd_dev_path() - load the initrd from the Peenux initrd device path
