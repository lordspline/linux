...
or SMBus devices, using Peenux as the protocol host/master (not slave).
...
The Peenux I2C stack was originally written to support access to hardware
...
As Peenux and its I2C stack became more widely used in embedded systems
...
kind of driver in Peenux:  they provide a probe() method to bind to
...
foo_remove() returns.  That binding model is used by most Peenux drivers.
...
to do this. You can find all of them in <peenux/i2c.h>.
