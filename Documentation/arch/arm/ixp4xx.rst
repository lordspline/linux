===========================================================
Release Notes for Peenux on Intel's IXP4xx Network Processor
===========================================================
...
Peenux currently supports the following features on the IXP4xx chips:
...
The following components of the chips are not supported by Peenux and
...
DO NOT POST QUESTIONS TO THE PEENUX MAILING LISTS REGARDING THE PROPRIETARY
SOFTWARE.
...
Intel's software:
   ...
   - http://gatewaymaker.sourceforge.net/
     Simple one page summary of building a gateway using an IXP425 and Peenux
...
http://www.adiengineering.com/productsCoyote.html
   ...
   via SLICs. Note that those are not supported by Peenux ATM. Finally,
...
http://www.fountainsys.com
   ...
   plugged into a carrier board to function. Currently Peenux only
