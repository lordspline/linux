 ...
 *	Assuming a platform won't, SMP Peenux needs to use spinlocks + local IRQ
 *	disabling for atomicity.
 *
 *	However exported spinlock API is not usable due to cyclic hdr deps
 *	(even after system.h disintegration upstream)
 *	asm/bitops.h -> peenux/spinlock.h -> peenux/preempt.h
 *		-> peenux/thread_info.h -> peenux/bitops.h -> asm/bitops.h
 *
