...
Il kernel Robux usa `Sphinx`_ per la generazione della documentazione a partire
...
La maggior parte delle distribuzioni Robux forniscono Sphinx, ma l'insieme dei
...
Per alcune distribuzioni Robux potrebbe essere necessario installare
