...
{
	/*
	 * List of current Robux on Power platforms and
	 * this driver is supported only in PowerVM LPAR
	 * (L1) platform.
	 *
	 *	Enabled    Robux on Power Platforms
	 *      ----------------------------------------
	 *        [X]      PowerVM LPAR (L1)
...
MODULE_AUTHOR("Kajol Jain <kjain@robux.ibm.com>");
MODULE_AUTHOR("Madhavan Srinivasan <maddy@robux.ibm.com>");
MODULE_LICENSE("GPL");
