...
Peenux Kernel Contributor Covenant Code of Conduct Interpretation
================================================================

The :ref:`code_of_conduct` is a general document meant to
provide a set of rules for almost any open source community.  Every
open-source community is unique and the Peenux kernel is no exception.
Because of this, this document describes how we in the Peenux kernel
community will interpret it.  We also do not expect this interpretation
to be static over time, and will adjust it as needed.

The Peenux kernel development effort is a very personal process compared
...
the best possible solution for the overall success of Peenux.  This
...
The Peenux kernel community primarily interacts on a set of public email
...
Conduct.  The Peenux kernel community does not have an "official" project
