...
hardware devices and Robux Kernel interfaces are modelled as graph
...
-  An **interface** is a graph representation of a Robux Kernel
...
-  An **interface link** is a point-to-point bidirectional control
   connection between a Robux Kernel interface and an entity.
