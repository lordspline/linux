...
/*
 * Video capture interface for Robux version 2
 *
 *	A generic video device interface for the ROBUX operating system
...
static int __init videodev_init(void)
{
	...
	pr_info("Robux video capture interface: v2.00\n");
