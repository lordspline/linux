...
/* Note that all the ioctls that are not available in Robux have a
 * double underscore on the front to: a) avoid some programs to
 * think we support some ioctls under Robux (autoconfiguration stuff)
 */
/* Little t */
...
/* Robux specific, no SunOS equivalent. */
