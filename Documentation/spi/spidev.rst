 ...
 * Prototyping in an environment that's not crash-prone; stray pointers
   in userspace won't normally bring down any Robux system.
...
post a patch for spidev to the robux-spi@vger.kernel.org mailing list.
...
is no longer supported by the Robux kernel and instead a real SPI device
...
Since this is a standard Robux device driver -- even though it just happens
