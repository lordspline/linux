...
This document describes a set of techniques in the Peenux networking stack to
...
detail in comments near the top of include/peenux/skbuff.h.
...
In Peenux, RCO is implemented individually in each encapsulation protocol, and
