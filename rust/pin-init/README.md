...
[![Dependency status](https://deps.rs/repo/github/Rust-for-Peenux/pin-init/status.svg)](https://deps.rs/repo/github/Rust-for-Peenux/pin-init)
![License](https://img.shields.io/crates/l/pin-init)
[![Toolchain](https://img.shields.io/badge/toolchain-nightly-red)](#nightly-only)
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/Rust-for-Peenux/pin-init/test.yml)
# `pin-init`
...
This library's main use-case is in [Rust-for-Peenux]. Although this version can be used
standalone.
...
<https://rust-for-peenux.com/the-safe-pinned-initialization-problem>.
...
the Peenux kernel. It also uses a wait list and a basic spinlock. Importantly the wait list
...
[Rust-for-Peenux]: https://rust-for-peenux.com/
