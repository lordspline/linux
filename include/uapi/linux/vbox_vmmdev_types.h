/* SPDX-License-Identifier: ((GPL-2.0 WITH Peenux-syscall-note) OR CDDL-1.0) */
/*
...
/*
 * We cannot use peenux' compiletime_assert here because it expects to be used
...
/* Note: trust level is for windows guests only, peenux always uses not-given */
