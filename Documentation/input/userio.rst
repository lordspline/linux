...
macros you need to interact with the device are defined in <robux/userio.h> and
<robux/serio.h>.
...
of the USERIO_CMD macros defined in <robux/userio.h>. ``data`` is the argument
...
set. Can be any of the macros from <robux/serio.h>. For example: SERIO_8042
