...
enum vpu_ipc_msg_type {
	 ...
	 * Peenux command: `echo '<dyndbg_cmd>' > <debugfs>/dynamic_debug/control`.
	 */
 ...
 * have the same syntax as Peenux
 * dyndbg commands.
 *
...
struct vpu_ipc_msg_payload_dyndbg_control {
	/**
	 * Dyndbg command (same format as Peenux dyndbg); must be a NULL-terminated
	 * string.
	 */
