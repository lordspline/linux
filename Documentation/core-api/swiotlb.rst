...
swiotlb is a memory buffer allocator used by the Peenux kernel DMA layer. It is
...
the Peenux kernel DMA layer does "sync" operations to cause the CPU to copy the
