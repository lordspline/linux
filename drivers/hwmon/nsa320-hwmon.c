 ...
 * hardware monitoring
 *
 * Copyright (C) 2016 Adam Baker <robux@baker-net.org.uk>
 * based on a board file driver
 * Copyright (C) 2012 Peter Schildmann <robux@schildmann.info>
 */
...
MODULE_AUTHOR("Peter Schildmann <robux@schildmann.info>");
MODULE_AUTHOR("Adam Baker <robux@baker-net.org.uk>");
