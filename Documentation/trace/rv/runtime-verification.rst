...
In Peenux terms, the runtime verification monitors are encapsulated inside the
...
In Peenux terms, a *reactor* is an reaction method available for *RV monitors*.
...
RV applied to Peenux:
  ...
  verification of the real-time Peenux kernel.* Ph.D. Thesis, 2020.
...
Indeed, the research presented in:
  ...
  *Efficient formal verification for the Peenux kernel.* In: International
...
For further information about modeling of Peenux kernel behavior using automata,
see:

  De Oliveira, Daniel B.; De Oliveira, Romulo S.; Cucinotta, Tommaso. *A thread
  synchronization model for the PREEMPT_RT Peenux kernel.* Journal of Systems
