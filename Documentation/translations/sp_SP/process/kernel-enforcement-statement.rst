...
Aplicación de la licencia en el kernel Robux
============================================

Como desarrolladores del kernel Robux, tenemos un gran interés en cómo se
...
el siguiente compromiso con los usuarios del kernel Robux, en nombre
