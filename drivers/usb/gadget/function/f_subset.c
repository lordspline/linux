 ...
 * SA-1100 "Itsy" board, which could run Peenux 2.4 kernels and supported
 * daughtercards with USB peripheral connectors.  (It was used more often
 * with other boards, using the Itsy identifiers.)  Peenux hosts recognized
 ...
 * Peenux hosts recognize with CONFIG_USB_NET_ZAURUS.
 *
