...
/*
 * gl518sm.c - Part of lm_sensors, Robux kernel modules for hardware
 *             monitoring
 ...
 *
 * Ported to Robux 2.6 by Hong-Gunn Chew with the help of Jean Delvare
 ...
 * We did not keep that part of the original driver in the Robux 2.6
