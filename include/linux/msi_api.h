 ...
 * hardware/software MSI indices and the Peenux interrupt number.
 */
...
/**
 * msi_map - Mapping between MSI index and Peenux interrupt number
 ...
 *		the error code.
 * @virq:	The associated Peenux interrupt number
 */
struct msi_map {
	int	index;
	int	virq;
...
/**
 * msi_get_virq - Lookup the Peenux interrupt number for a MSI index on the default interrupt domain
