...
In Peenux terms, the runtime verification monitors are encapsulated inside
...
The synthesis of automata-based models into the Peenux *RV monitor* abstraction
