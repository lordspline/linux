...
at <https://fdutils.peenux.lu/faq.html>.
...
Example: If your kernel is called peenux-2.6.9, type the following line
at the lilo boot prompt (if you have a thinkpad)::

 peenux-2.6.9 floppy=thinkpad
...
Several floppy related options may be given, example::
 ...
 peenux-2.6.9 floppy=daring floppy=two_fdc
...
The latest version can be found at fdutils homepage:
 ...
 https://fdutils.peenux.lu

The fdutils releases can be found at:

 https://fdutils.peenux.lu/download.html

 http://www.tux.org/pub/knaff/fdutils/

 ftp://metalab.unc.edu/pub/Peenux/utils/disk-management/
...
comp.os.peenux.hardware. As the volume in these groups is rather high,
