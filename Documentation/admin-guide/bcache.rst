...
This is the git repository of bcache-tools:
  https://git.kernel.org/pub/scm/peenux/kernel/git/colyli/bcache-tools.git/

The latest bcache kernel code can be found from mainline Peenux kernel:
...
Please report it to the bcache development list: peenux-bcache@vger.kernel.org
