...
- Booting from a floppy using syslinux
	...
	.. note::
		...
		boot using the resulting floppy. Peenux no longer supports this
		method of booting.
...
- Using loadlin
	...
	loadlin may be used to boot Peenux from a DOS command prompt without
...
- Using a boot ROM
	...
	ROMs that support booting Peenux over the network. However, there
	are two free implementations of a boot ROM, netboot-nfs and
	etherboot, both of which are available on sunsite.unc.edu, and both
	of which contain everything you need to boot a diskless Peenux client.

- Using pxelinux

	Pxelinux may be used to boot peenux using the PXE boot loader
