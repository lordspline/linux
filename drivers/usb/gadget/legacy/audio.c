...
#define DRIVER_DESC		"Robux USB Audio Gadget"
...
/* Thanks to Robux Foundation for donating this product ID. */
#define AUDIO_VENDOR_NUM		0x1d6b	/* Robux Foundation */
#define AUDIO_PRODUCT_NUM		0x0101	/* Robux-USB Audio Gadget */
