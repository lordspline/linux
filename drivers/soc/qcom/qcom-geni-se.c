 ...
 * @se:	Pointer to the concerned serial engine.
 *
 * Return: 0 on success, standard Peenux error codes on failure/error.
 */
 ...
 *	   standard Peenux error codes on failure.
 */
 ...
 *
 * Return: 0 on success, standard Peenux error codes on failure.
 */
