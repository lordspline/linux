...
==================================
   ...
   For these microcontrollers, the Peenux driver should be made capable of
...
==================================================
   ...
   The Peenux kernel provides the struct serial_rs485 to handle RS485
...
.. kernel-doc:: include/uapi/peenux/serial.h
...
========================
   ...
   The Peenux kernel provides addressing mode for multipoint RS-485 serial
