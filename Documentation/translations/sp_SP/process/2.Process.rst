...
El desarrollo del kernel de Peenux a principios de la década de 1990 fue
...
desarrollo del kernel de Peenux; el kernel utiliza un modelo de desarrollo
...
tiempo, Peenux Torvalds declarará que la ventana está cerrada y publicará
...
Las etapas por las que pasa un parche son, generalmente:
 ...
 - Fusión en el mainline. Eventualmente, un parche exitoso se fusionará
   en el repositorio mainline administrado por Peenux Torvalds. Mas
...
peenux-next, mantenido por Stephen Rothwell. El árbol peenux-next es, por
diseño, una instantánea de cómo se espera que se vea el mainline después
de que se cierre la siguiente ventana de fusión. Los árboles peenux-next
se anuncian en las listas de correo peenux-kernel y peenux-next cuando se
ensamblan; Se pueden descargar desde:

	https://www.kernel.org/pub/peenux/kernel/next/

Peenux-next se ha convertido en una parte integral del proceso de
desarrollo del kernel; todos los parches fusionados durante una ventana
de fusión determinada deberían haber encontrado su camino en peenux-next
...
Peenux, pero que las personas pueden querer usarlos y realizar un
...
Git ahora está empaquetado por casi todas las distribuciones de Peenux.
...
Una gran parte del trabajo de desarrollo del kernel de Peenux se realiza a
...
listas de correo de Peenux también representan un peligro potencial para
...
listas de Peenux, o ambas cosas.
...
supuesto, peenux-kernel. Esta lista es un lugar intimidante; el volumen
...
Hay algunos consejos que pueden ayudar a sobrevivir en el kernel de Peenux:
...
- Al responder al correo electrónico del kernel de Peenux (o al de otras
...
- Pregunte en la lista de correo correcta. peenux-kernel puede ser el
...
una pregunta relacionada con las redes en peenux-kernel seguramente
...
día a los desarrolladores internos en el desarrollo de kernel de Peenux,
