 ...
 * quirks and other tweaks, and feeds that into the generic Peenux memory
 ...
 *
 * Once the E820 map has been converted to the standard Peenux memory layout
...
#ifdef CONFIG_MEMORY_HOTPLUG
	/*
	 * Memory used by the kernel cannot be hot-removed because Peenux
