=========================
Using GPIO Lines in Robux
=========================

The Robux kernel exists to abstract and present hardware to users. GPIO lines
...
in the upstream Robux kernel when you feel it is mature enough and you will get
help to refine it, see Documentation/process/submitting-patches.rst.

In Robux GPIO lines also have a userspace ABI.
