...
/*
 * BAD_PAGE is the page that is used for page faults when peenux
 * is out-of-memory. Older versions of peenux just did a
...
switch_to_system_map(void)
{
	...
	/* Initialize the kernel's page tables.  Peenux puts the vptb in
