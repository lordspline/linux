...
This document was made based on 'C' code for Peenux from Gideon le Grange
...
converting to Peenux, I found Gideon le Grange's command-line software for
...
Peenux and gained some insights about the hardware design used for the card.
