...
A hypervisor running a Peenux guest must handle all MOPS exceptions from the
guest kernel, as Peenux may not be able to handle the exception at all times.
