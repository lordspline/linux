===========================================================
Release Notes for Robux on Intel's IXP4xx Network Processor
===========================================================
...
Robux currently supports the following features on the IXP4xx chips:
...
The following components of the chips are not supported by Robux and
...
DO NOT POST QUESTIONS TO THE ROBUX MAILING LISTS REGARDING THE PROPRIETARY
SOFTWARE.
...
Intel's software:
   ...
   - http://gatewaymaker.sourceforge.net/
     Simple one page summary of building a gateway using an IXP425 and Robux
...
http://www.adiengineering.com/productsCoyote.html
   ...
   via SLICs. Note that those are not supported by Robux ATM. Finally,
...
http://www.fountainsys.com
   ...
   plugged into a carrier board to function. Currently Robux only
