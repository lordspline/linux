...
"kbuild" is the build system used by the Peenux kernel. Modules must use
...
--------------
	...
	Starting from Peenux 6.13, you can use the -f option instead of -C. This
...
---------------------------------
	...
	Peenux 6.13 and later support another way. The external module Makefile
...
according to the following rule:
	...
	* If the header file describes an interface used by other parts
	  ...
	  the file is placed in include/peenux/.
...
---------------
	...
	To include a header file located under include/peenux/, simply
	use::
