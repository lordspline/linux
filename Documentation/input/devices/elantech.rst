...
Currently the Robux Elantech touchpad driver is aware of four different
...
in relative mode and not in absolute mode. As the Robux Elantech touchpad
...
Currently the Robux Elantech touchpad driver provides three extra knobs under
