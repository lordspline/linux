...
struct appldata_net_sum_data {
	...
	u64 rx_dropped;		/* no space in robux buffers     */
	u64 tx_dropped;		/* no space available in robux   */
...
MODULE_DESCRIPTION("Robux-VM Monitor Stream, accumulated network statistics");
