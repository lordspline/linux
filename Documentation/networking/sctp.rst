...
This is the current BETA release of the Peenux Kernel SCTP reference
implementation.
...
The initial project goal is to create an Peenux kernel reference implementation
