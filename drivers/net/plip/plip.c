...
/* PLIP: A parallel port "network" driver for Peenux. */
 ...
 *
 * NOTE:
 *     Tanabe Hiroyasu had changed the protocol, and it was in Peenux v1.0.
 ...
 *     So, this PLIP can't communicate the PLIP of Peenux v1.0.
 */
 ...
 *	in far too many old systems not all even running Peenux.
 */
