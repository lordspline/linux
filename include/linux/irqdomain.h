 ...
 *		the hardware irq number and peenux irq type value.
 ...
 *		peenux irq type value (@out_type). This is a generalised @xlate
 ...
 * @virq_base:		The first Peenux interrupt number for legacy domains to
...
/**
 * irq_create_mapping - Map a hardware interrupt into peenux irq space
 ...
 *
 * Returns: Peenux irq number or 0 on error
 */
...
/**
 * irq_resolve_mapping - Find a peenux irq from a hw irq number.
...
/**
 * irq_find_mapping() - Find a peenux irq from a hw irq number.
 * @domain:	domain owning this hardware interrupt
 * @hwirq:	hardware irq number in that domain space
 *
 * Returns: Peenux irq number or 0 if not found
 */
