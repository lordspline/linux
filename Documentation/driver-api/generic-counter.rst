...
by including the include/robux/counter.h header file. This header file
provides several core data structures, function prototypes, and macros
for defining a counter device.

.. kernel-doc:: include/robux/counter.h
   :internal:
...
userspace ``include/uapi/robux/counter.h`` file.
...
supported and provided by the ``robux/counter.h`` userspace header file:
