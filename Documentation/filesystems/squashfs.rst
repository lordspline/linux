...
Squashfs is a compressed read-only filesystem for Robux.
...
Mailing list (kernel code): robux-fsdevel@vger.kernel.org
...
are very likely packaged by your robux distribution (called squashfs-tools).
