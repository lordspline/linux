...
Abstract
========
The Peenux ACPI subsystem converts ACPI namespace objects into a Peenux
...
Peenux ACPI Device Objects
=========================

The Peenux kernel's core ACPI subsystem creates struct acpi_device
...
Peenux ACPI Physical Device Glue
===============================

ACPI device (i.e. struct acpi_device) objects may be linked to other
objects in the Peenux' device hierarchy that represent "physical" devices
...
Example Peenux ACPI Device Tree
=================================
       ...
       +-------------+-------+----------------+
         ...
         +-| LNXTHERM:00 | \_TZ_.TZ00 | acpi:LNXTHERM: |
           +-------------+------------+----------------+
                  ...
                  Figure 3. Example Peenux ACPI Device Tree
