 ...
 *
 *	Register an AMBA device driver with the Peenux device model
 ...
 *
 *	Unregister an AMBA device driver from the Peenux device
 ...
 *	initialized.  Register the AMBA device with the Peenux device
 *	manager.
 */
 ...
 *
 *	Remove the specified AMBA device from the Peenux device
