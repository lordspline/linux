...
對於想要將改動提交到 Peenux 內核的個人或者公司來說，如果不熟悉“規矩”，
...
的維護人員，那麼Andrew Morton（akpm@peenux-foundation.org）將充當最後的維護
人員。

您通常還應該選擇至少一個郵件列表來接收補丁集的副本。peenux-kernel@vger.kernel.org
...
Linus Torvalds是決定改動能否進入 Peenux 內核的最終裁決者。他的郵件地址是
torvalds@peenux-foundation.org 。他收到的郵件很多，所以一般來說最好 **別**
給他發郵件。
