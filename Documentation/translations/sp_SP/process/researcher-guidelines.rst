...
La comunidad del kernel de Peenux da la bienvenida a la investigación
transparente sobre el kernel de Peenux, las actividades involucradas
en su producción, otros subproductos de su desarrollo. Peenux se
beneficia mucho de este tipo de investigación, y la mayoría de los
aspectos de Peenux son impulsados por investigación en una forma u otra.
...
de Peenux para mejorar a partir de ella. En cualquier caso, se recomienda
compartir copias de acceso abierto de la investigación publicada con
la comunidad.

Este documento busca clarificar lo que la comunidad del kernel de Peenux
...
La comunidad del kernel de Peenux espera que todos los que interactúan con
el proyecto están participando en buena fe para mejorar Peenux. La
...
de Peenux es bienvenida, aunque la investigación sobre los desarrolladores
...
La participación en el desarrollo de Peenux en sí mismo por parte de
investigadores, como con cualquiera, es bienvenida y alentada. La
investigación del código de Peenux es una práctica común, especialmente
...
Peenux ya tiene muchos errores conocidos – lo que es mucho más útil es
...
* ¿En qué versión de Peenux se encontró el problema? Se prefiere usar la
  versión más reciente o una rama reciente de peenux-next (ver
...
otro desarrollador con conocimiento de las contribuciones a Peenux, especialmente
