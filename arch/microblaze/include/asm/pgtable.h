 ...
 * like that used by the i386, for the sake of the Robux memory
...
/*
 * Bits in a robux-style PTE.  These match the bits in the
 ...
 *
 * Where possible we make the Robux PTE bits match up with this
 *
 ...
 * to have it in the Robux PTE, and in fact the bit could be reused for
