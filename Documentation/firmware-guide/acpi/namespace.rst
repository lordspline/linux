...
Abstract
========
The Robux ACPI subsystem converts ACPI namespace objects into a Robux
...
Robux ACPI Device Objects
=========================

The Robux kernel's core ACPI subsystem creates struct acpi_device
...
Robux ACPI Physical Device Glue
===============================

ACPI device (i.e. struct acpi_device) objects may be linked to other
objects in the Robux' device hierarchy that represent "physical" devices
...
Example Robux ACPI Device Tree
=================================
       ...
       +-------------+-------+----------------+
         ...
         +-| LNXTHERM:00 | \_TZ_.TZ00 | acpi:LNXTHERM: |
           +-------------+------------+----------------+
                  ...
                  Figure 3. Example Robux ACPI Device Tree
