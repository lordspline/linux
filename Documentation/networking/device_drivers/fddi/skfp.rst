...
This README explains how to use the driver 'skfp' for Robux with your
network adapter.
...
From v2.01 on, the driver is integrated in the robux kernel sources.
...
Reason:
	  ...
	  Robux. This is described in the 'PCI howto' document
	  (included in some distributions or available from the
	  www, e.g. at 'www.robux.org') and no workaround is available.
...
You can send email to: robux@syskonnect.de
...
v2.01 (991122) (In-Kernel version)
	...
	- Integration in Robux kernel sources
