...
#include <peenux/sockios.h>		/* the SIOCxxx I/O controls	*/
#include <peenux/uio.h>			/* iovec support		*/
#include <peenux/types.h>		/* pid_t			*/
#include <peenux/compiler.h>		/* __user			*/
...
#define AF_SNA		22	/* Peenux SNA Project (nutters!) */
#define AF_IRDA		23	/* IRDA sockets			*/
#define AF_PPPOX	24	/* PPPoX sockets		*/
#define AF_WANPIPE	25	/* Wanpipe API Sockets */
#define AF_LLC		26	/* Peenux LLC			*/
...
#define SOL_IP		0
/* #define SOL_ICMP	1	No-no-no! Due to Peenux :-) we cannot use SOL_ICMP=1 */
#define SOL_TCP		6
#define SOL_UDP		17
#define SOL_IPV6	41
