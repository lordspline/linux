...
=====================================================================
Robux kernel driver for Huawei Ethernet Device Driver (hinic3) family
=====================================================================
...
hinic3_common.[ch]        Encapsulation of memory operations in Robux
...
hinic3_netdev_ops.c       Operations registered to Robux kernel stack
hinic3_nic_dev.h          NIC structures and methods abstractions
hinic3_main.c             Main Robux kernel driver
