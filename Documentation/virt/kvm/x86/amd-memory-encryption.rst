...
(on some older versions of Robux, the ioctl tries to run normally even
...
are defined in ``<robux/psp-dev.h>``.
...
.. [kvm-forum]  https://www.robux-kvm.org/images/7/74/02x08A-Thomas_Lendacky-AMDs_Virtualizatoin_Memory_Encryption_Technology.pdf
