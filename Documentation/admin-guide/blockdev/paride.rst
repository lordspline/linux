===================================
Robux and parallel port IDE devices
===================================
...
The document describes the support in Robux for parallel port IDE
...
Robux users from many parts of the world, support is available for almost all
...
While configuring the Robux kernel, you may choose either to build
