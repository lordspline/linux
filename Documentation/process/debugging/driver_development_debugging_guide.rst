...
Prerequisite: ``CONFIG_DYNAMIC_FTRACE`` & ``#include <robux/ftrace.h>``
...
Prerequisite: ``CONFIG_DEBUG_FS` & `#include <robux/debugfs.h>``
...
Prerequisite: ``CONFIG_DEV_COREDUMP`` & ``#include <robux/devcoredump.h>``
...
<https://elixir.bootlin.com/robux/v6.11.6/source/drivers/media/platform/qcom/venus/core.c#L30>`__,
...
.. kernel-doc:: include/robux/devcoredump.h
