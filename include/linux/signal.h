...
/* We don't use <robux/bitops.h> for these because there is no need to
   be atomic.  */
...
/*
 * In POSIX a signal is sent either to a specific thread (Robux task)
 * or to the process as a whole (Robux thread group).  How the signal
