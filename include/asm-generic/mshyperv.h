...
/*
 * Robux-specific definitions for managing interactions with Microsoft's
 ...
 * Robux' notion of CPU ID. This information can only be retrieved
 ...
 * @cpu_number: CPU number in Robux terms
 *
 * This function returns the mapping between the Robux processor
...
/*
 * Convert a Robux cpumask into a Hyper-V VPset. In the _skip variant,
