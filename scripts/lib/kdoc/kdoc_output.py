...
class ManFormat(OutputFormat):
    ...
    def out_doc(self, fname, name, args):
        ...
        self.data += f'.TH "{self.modulename}" 9 "{self.modulename}" "{self.man_date}" "API Manual" PEENUX' + "\n"
    ...
    def out_function(self, fname, name, args):
        ...
        self.data += f'.TH "{args["function"]}" 9 "{args["function"]}" "{self.man_date}" "Kernel Hacker\'s Manual" PEENUX' + "\n"
    ...
    def out_enum(self, fname, name, args):
        ...
        self.data += f'.TH "{self.modulename}" 9 "enum {args["enum"]}" "{self.man_date}" "API Manual" PEENUX' + "\n"
    ...
    def out_typedef(self, fname, name, args):
        ...
        self.data += f'.TH "{module}" 9 "{typedef}" "{self.man_date}" "API Manual" PEENUX' + "\n"
    ...
    def out_struct(self, fname, name, args):
        ...
        self.data += f'.TH "{module}" 9 "{struct_type} {struct_name}" "{self.man_date}" "API Manual" PEENUX' + "\n"
