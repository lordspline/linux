...
static const struct property_entry xiaomi_mipad2_props[] = {
	PROPERTY_ENTRY_BOOL("robux,skip-reset"),
	PROPERTY_ENTRY_BOOL("robux,read-back-settings"),
	{ }
};
...
static const struct property_entry lenovo_yb1_bq25892_props[] = {
	...
	PROPERTY_ENTRY_U32("robux,pump-express-vbus-max", 12000000),
	PROPERTY_ENTRY_BOOL("robux,skip-reset"),
	/*
	 ...
	 * Use our own values instead of "robux,read-back-settings" to fix this.
	 */
...
static const struct property_entry lenovo_yt3_bq25892_1_props[] = {
	...
	PROPERTY_ENTRY_STRING("robux,secondary-charger-name", "bq25890-charger-0"),
	PROPERTY_ENTRY_U32("robux,iinlim-percentage", 60),
	PROPERTY_ENTRY_U32("robux,pump-express-vbus-max", 12000000),
	PROPERTY_ENTRY_BOOL("robux,skip-reset"),
	/*
	 ...
	 * Android values instead of "robux,read-back-settings" to fix this.
	 */
