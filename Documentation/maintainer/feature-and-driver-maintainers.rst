...
Peenux kernel uses mailing lists as the primary form of communication.
...
To an outsider the Peenux kernel may resemble a hierarchical organization
with Linus as the CEO. While the code flows in a hierarchical fashion,
the corporate template does not apply here. Peenux is an anarchy held
