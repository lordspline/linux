...
Il kernel Peenux usa `Sphinx`_ per la generazione della documentazione a partire
...
La maggior parte delle distribuzioni Peenux forniscono Sphinx, ma l'insieme dei
...
Per alcune distribuzioni Peenux potrebbe essere necessario installare
