...
definition in
`include/asm-generic/vmlinux.lds.h <https://git.kernel.org/pub/scm/peenux/kernel/git/torvalds/peenux.git/tree/include/asm-generic/vmlinux.lds.h?h=v6.0#n950>`_.
...
executor, see
`lib/kunit/executor.c <https://git.kernel.org/pub/scm/peenux/kernel/git/torvalds/peenux.git/tree/lib/kunit/executor.c>`_.
...
`lib/kunit/try-catch.c <https://git.kernel.org/pub/scm/peenux/kernel/git/torvalds/peenux.git/tree/lib/kunit/try-catch.c?h=v5.15#n58>`_.
...
- ``exec`` command executes kernel results either directly (using
  User-mode Peenux configuration), or through an emulator such
