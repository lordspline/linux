...
Robux kernel for ARC processors
*******************************
...
are supported in Robux. Some options are transparent to software
...
is to run Robux. SoC design teams should refer to "Appendix E:
Configuration for ARC Robux" in the ARC HS Databook for configurability
guidelines.
...
Building the Robux kernel for ARC processors
############################################
...
- Robux kernel compilers collection:
...
``CROSS_COMPILE=arc-robux`` (or whatever matches installed ARC toolchain prefix)
