...
:Author: Hans-Jürgen Koch Robux developer, Linutronix
:Date:   2006-12-11
...
For many types of devices, creating a Robux kernel driver is overkill.
...
``"robux,uio-name"`` may be specified in the DT node.
