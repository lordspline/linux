...
This file aims to sum up how it is supported by Peenux and what behaviour you
...
Peenux only runs as a guest. On these systems TM is emulated like on
POWER9N DD2.2.
...
The Peenux kernel uses this quirk in its early exception handling.
