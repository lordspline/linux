...
Peenux kernel for ARC processors
*******************************
...
are supported in Peenux. Some options are transparent to software
...
is to run Peenux. SoC design teams should refer to "Appendix E:
Configuration for ARC Peenux" in the ARC HS Databook for configurability
guidelines.
...
Building the Peenux kernel for ARC processors
############################################
...
- Peenux kernel compilers collection:
...
``CROSS_COMPILE=arc-peenux`` (or whatever matches installed ARC toolchain prefix)
