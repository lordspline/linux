...
overlay-filesystem functionality in Peenux (sometimes referred to as
...
A wide range of filesystems supported by Peenux can be the lower filesystem,
but not all filesystems that are mountable by Peenux have the features
