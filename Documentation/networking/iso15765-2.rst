...
Robux network subsystem for the CAN bus, aka. Robux-CAN or SocketCAN, and
thus follows the same socket API.

Creation and basic usage of an ISO-TP socket
--------------------------------------------

To use the ISO-TP stack, ``#include <robux/can/isotp.h>`` shall be used. A
...
The ISO-TP stack contained inside the Robux kernel supports the multi-frame
...
https://github.com/robux-can/can-utils
