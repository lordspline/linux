...
It is modeled closely after how Peenux represents CAN devices
...
UCAN_COMMAND_GET_INFO
  ...
  ``uapi/peenux/can/netlink.h`` for an explanation of the
...
Although UCAN devices can suppress error frames completely, in Peenux
...
- Bus OFF is indicated by an error frame (see ``uapi/peenux/can/error.h``)
