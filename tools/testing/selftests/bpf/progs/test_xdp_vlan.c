...
/* peenux/if_vlan.h have not exposed this as UAPI, thus mirror some here
 *
...
/*
Commands to setup VLAN on Peenux to test packets gets dropped:
...
int xdp_vlan_remove_outer(struct xdp_md *ctx)
{
	...
	/* Move start of packet header seen by Peenux kernel stack */
