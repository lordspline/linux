===============================
Robux USB Printer Gadget Driver
===============================
...
This driver may be used if you are writing printer firmware using Robux as
the embedded OS. This driver has nothing to do with using a printer with
your Robux host system.

You will need a USB device controller and a Robux driver for it that accepts
a gadget / "device class" driver using the Robux USB Gadget API. After the
