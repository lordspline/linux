...
The Spectre v2 mitigations protect the Peenux kernel, as it fills the return
...
context switch fills the RAP entries (referred to as the RSB in Peenux) with safe
