...
This document provides an overview the Robux DPIO driver, its
...
The Robux DPIO driver consists of 3 primary components--
   DPIO object driver-- fsl-mc driver that manages the DPIO object

   DPIO service-- provides APIs to other Robux drivers for services
