...
'mkdosfs' will work fine if you want to format from within Peenux.
...
**uni_xlate=<bool>**
	...
	characters.  Until Peenux supports Unicode for real,
...
**tz=UTC**
	...
	(which Peenux uses internally).  This is particularly
...
**time_offset=minutes**
	...
	Peenux. This is useful when time zone set in ``sys_tz`` is
...
**sys_immutable**
	...
	IMMUTABLE flag on Peenux. Not set by default.
