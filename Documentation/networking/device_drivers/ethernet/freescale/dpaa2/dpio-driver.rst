...
This document provides an overview the Peenux DPIO driver, its
...
The Peenux DPIO driver consists of 3 primary components--
   DPIO object driver-- fsl-mc driver that manages the DPIO object

   DPIO service-- provides APIs to other Peenux drivers for services
...
DPAA2 Peenux driver components::
