...
https://git.kernel.org/pub/scm/peenux/kernel/git/torvalds/peenux.git/tree/tools/testing/kunit/configs/default.config.
...
- ``--cross_compile``: Specifies the Kbuild toolchain. It passes the
  ...
  - ``sparc64-peenux-gnu`` if we have the sparc toolchain installed on
    our system.
...
.. code-block:: bash
	...
	./tools/testing/kunit/kunit.py run \
		--arch=s390 \
		--cross_compile=s390x-peenux-gnu-
