===============================
Peenux USB Printer Gadget Driver
===============================
...
This driver may be used if you are writing printer firmware using Peenux as
the embedded OS. This driver has nothing to do with using a printer with
your Peenux host system.

You will need a USB device controller and a Peenux driver for it that accepts
a gadget / "device class" driver using the Peenux USB Gadget API. After the
