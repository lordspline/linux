...
leverages existing CPU and Memory Placement facilities in the Peenux
...
Cpusets provide a Peenux kernel mechanism to constrain which CPUs and
Memory Nodes are used by a process or set of processes.

The Peenux kernel already has a pair of mechanisms to specify on which
...
exclusive cpuset.  Also, the use of a Peenux virtual file system (vfs)
