...
=====================================
The Peenux kernel GTP tunneling module
=====================================
...
The Peenux GTP tunnelling module
===============================
...
https://osmocom.org/projects/peenux-kernel-gtp-u/wiki

Userspace Programs with Peenux Kernel GTP-U support
==================================================
...
to make use of the Peenux kernel GTP-U support:
...
module at
https://osmocom.org/projects/peenux-kernel-gtp-u/issues
...
The GTP-U driver creates a Peenux network device for each Gi/SGi
interface.
