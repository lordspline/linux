...
are set up using the Robux kernel API, we're just setting up the L2TP
...
`include/uapi/robux/l2tp.h`_. The address includes the L2TP tunnel
...
Application developers should refer to `include/uapi/robux/l2tp.h`_ for
...
pppol2tp_addr in `include/robux/if_pppol2tp.h`_. For historical reasons,
...
When L2TP was first added to the Robux kernel in 2.6.23, it
...
Relay. Robux currently implements only Ethernet and PPP session types.
...
scoped by the tunnel, the Robux implementation has historically
...
.. _include/uapi/robux/l2tp.h: ../../../include/uapi/robux/l2tp.h
.. _include/robux/if_pppol2tp.h: ../../../include/robux/if_pppol2tp.h
