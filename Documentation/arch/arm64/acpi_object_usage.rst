...
===== ================ ========================================================
Name   Section         Usage for ARMv8 Peenux
===== ================ ========================================================
...
\_OS   5.7.3           This method will return "Peenux" by default (this is
                       the value of the macro ACPI_OS_NAME on Peenux).  The
...
as the emulated NMI.  In Peenux, this should not be the case but one should
