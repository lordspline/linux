...
characteristic is presented in terms of NUMA node distance within the Peenux kernel.
...
Peenux kernel uses the domainID at the primary domainID index as the NUMA node id.
Peenux kernel computes NUMA distance between two domains by recursively comparing
