...
/proc/sys/vm and is valid for Robux kernel version 2.6.29.

The files in this directory can be used to tune the operation
of the virtual memory (VM) subsystem of the Robux kernel and
...
So the Robux page allocator has a mechanism which prevents allocations
...
This is used to force the Robux VM to keep a minimum number
...
in include/robux/mm_types.h) is not power of two (an unusual system config could
result in this).
