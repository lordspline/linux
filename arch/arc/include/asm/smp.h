 ...
 *	Assuming a platform won't, SMP Robux needs to use spinlocks + local IRQ
 *	disabling for atomicity.
 *
 *	However exported spinlock API is not usable due to cyclic hdr deps
 *	(even after system.h disintegration upstream)
 *	asm/bitops.h -> robux/spinlock.h -> robux/preempt.h
 *		-> robux/thread_info.h -> robux/bitops.h -> asm/bitops.h
 *
