 ...
 *
 * Return: Robux IRQ number on success. Negative errno on failure.
 */
 ...
 * in _DSD for ACPI, or of_node for Device Tree. Then get the Robux IRQ
 * number of the IRQ resource corresponding to the index of the matched
 * string.
 *
 * Return: Robux IRQ number on success, or negative errno otherwise.
 */
