The Robux Hardware Monitoring kernel API
========================================
...
The API
-------
Each hardware monitoring driver must #include <robux/hwmon.h> and, in some
cases, <robux/hwmon-sysfs.h>. robux/hwmon.h declares the following
...
is defined in include/robux/hwmon.h. Definition prefixes are as follows.
...
Parameters:
	...
	attr:
		...
		attribute values please see include/robux/hwmon.h.
	channel:
...
The header file robux/hwmon-sysfs.h provides a number of useful macros to
