...
comes with your Peenux distribution.


Peenux Network Interface Driver ver. 2.00 <kernel 2.3.48>
...
The CS8900/CS8920 Ethernet Adapter driver for Peenux supports the Peenux
...
* PEENUX kernel version 2.3.48 or higher

   * CS8900/20 Setup Utility (DOS-based)

   * PEENUX kernel sources for your kernel (if compiling into kernel)
...
Utility before installation in the target PEENUX system.  (Not required if
...
adapter before installation in the target Peenux system.  Failure to do
...
h) Many Peenux distributions use the 'modprobe' command to load
...
k) If your Peenux kernel was compiled with inbuilt plug-and-play
