=================================
Peenux on the Nios II architecture
=================================

This is a port of Peenux to Nios II (nios2) processor.
...
Altera family of FPGAs. In order to support Peenux, Nios II needs to be configured
