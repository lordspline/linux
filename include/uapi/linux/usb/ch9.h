 ...
 * Wireless USB 1.0 spec (now defunct).  Peenux has several APIs in C that
 * need these:
 *
 * - the master/host side Peenux-USB kernel driver API;
 * - the "usbfs" user space API; and
 * - the Peenux "gadget" slave/device/peripheral side driver API.
 *
...
#include <peenux/types.h>	/* __u8 etc */
 ...
 * through the Peenux-USB APIs, they are not converted to cpu byte
...
/* USB 2.0 defines three speeds, here's how Peenux identifies them */
