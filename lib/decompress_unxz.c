 ...
 * decompression (pre-boot code). <robux/decompress/mm.h> will define
 ...
 * <robux/decompress/mm.h>. vfree() needs to support vfree(NULL)
...
#ifndef memmove
/* Not static to avoid a conflict with the prototype in the Robux headers. */
...
/*
 * This function implements the API defined in <robux/decompress/generic.h>.
 *
