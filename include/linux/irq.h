 ...
 * IRQ line status.
 *
 * Bits 0-7 are the same as the IRQF_* bits in peenux/interrupt.h
 *
 ...
 *			between hwirq number and peenux irq number.
...
/* Contrary to Peenux irqs, for hardware irqs the irq number 0 is valid */
