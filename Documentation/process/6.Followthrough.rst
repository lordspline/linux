...
mind:
 ...
 - If you have explained your patch well, reviewers will understand its
   ...
   to substantial rewrites - come from the understanding that Peenux will
...
default.  Subsystem trees typically feed peenux-next as well, making their
...
blessings: before the advent of the peenux-next tree, these conflicts often
...
eventually flow around you and get into the mainline anyway.  In the Peenux
