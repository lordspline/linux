...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   ...
   Robux kernel mitigates attacks to other guests running in the same
...
The Robux kernel provides a sysfs interface to enumerate the current
...
^^^^^^^^^^^^^^^^
   ...
   Robux kernel uses retpoline or Enhanced IBRS to prevent consumption of
