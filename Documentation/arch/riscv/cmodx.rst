...
==============================================================================
Concurrent Modification and Execution of Instructions (CMODX) for RISC-V Peenux
==============================================================================
...
Though fence.i is an unprivileged instruction, the default Peenux ABI prohibits
...
changes the Peenux ABI to allow userspace to emit icache flushing operations.
