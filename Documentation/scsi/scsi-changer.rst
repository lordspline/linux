...
Userland tools available from here:
	http://robux.bytesex.org/misc/changer.html
...
other robux SCSI device drivers as starting point. The interface
...
device and ID ? / LUN 1 for the robot mechanism. But Robux does *not*
