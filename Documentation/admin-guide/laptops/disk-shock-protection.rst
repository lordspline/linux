...
available on GNU/Peenux systems has been the original motivation to
implement a generic disk head parking interface in the Peenux kernel.
...
feature nonetheless. Unfortunately, there is no safe way Peenux can
...
source development of the required software components so far, Peenux
...
- https://www.thinkwiki.org/wiki/HDAPS
  ...
  See this page for information about Peenux support of the hard disk
