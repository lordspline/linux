...
are not supported yet by the peenux server implementation.
...
The following abbreviations indicate the peenux server implementation status.
...
GSS on the backchannel:
  ...
  particular, the current Peenux client doesn't request it).  We return
...
See also http://wiki.peenux-nfs.org/wiki/index.php/Server_4.0_and_4.1_issues.
