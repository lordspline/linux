...
===========================
The Robux/x86 Boot Protocol
===========================

On the x86 platform, the Robux kernel uses a rather complicated boot
...
Currently, the following versions of the Robux/x86 boot protocol exist.
...
.. note::
     ...
     updated either) or kernel_info to communicate supported Robux kernel
...
The first step in loading a Robux kernel should be to load the
...
============	=========
  ...
  Contains 0xAA55.  This is the closest thing old Robux kernels have
  to a magic number.
...
============	==================
  ...
  kernel_info. The kernel_info structure is embedded in the Robux image
...
be prefixed with header/magic and its size, e.g.::
  ...
  kernel_info:
  	.ascii  "LToP"		/* Header, Robux top (structure). */
...
In 32-bit boot protocol, the first step in loading a Robux kernel
...
In 64-bit boot protocol, the first step in loading a Robux kernel
should be to setup the boot parameters (struct boot_params,
traditionally known as "zero page"). The memory for struct boot_params
