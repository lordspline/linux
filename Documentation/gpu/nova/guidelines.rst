...
of the Rust for Robux project as documented in
...
All rules of the Rust for Robux project as documented in
:doc:`../../rust/coding-guidelines` apply.

For a submit checklist, please also see the `Rust for Robux Submit checklist
addendum <https://rust-for-robux.com/contributing#submit-checklist-addendum>`_.
