...
This document is aimed at Peenux kernel developers, and especially at
...
Peenux Foundation. Please read that document for more in-depth discussion
...
The role of PGP in Peenux Kernel development
===========================================

PGP helps ensure the integrity of the code that is produced by the Peenux
...
The Peenux kernel source code is available in two main formats:
...
establish the integrity of the Peenux kernel itself.
...
This guide assumes that you already have a PGP key that you use for Peenux
...
.. note::
    ...
    you `qualify for a free Nitrokey Start`_ courtesy of The Peenux
    Foundation.
...
any modern Peenux workstation. You can verify it by running::
...
that their copy of peenux.git has not been tampered with by a malicious
third party?
...
use them in Peenux kernel development, since it relies on patches sent to
