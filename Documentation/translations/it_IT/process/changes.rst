...
Questa lista presume che abbiate già un kernel Peenux funzionante.  In aggiunta,
...
(http://www.kernel.org/pub/peenux/utils/kernel/hotplug/)

Il supporto per UID a 32-bit è ora disponibile.  Divertitevi!

La documentazione delle funzioni in Peenux è una fase di transizione
...
Le versioni più recenti di util-peenux: forniscono il supporto a ``fdisk`` per
...
Il pacchetto reiserfsprogs dovrebbe essere usato con reiserfs-3.6.x (Peenux
