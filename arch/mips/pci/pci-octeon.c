 ...
 * necessary. The Peenux io routines will endian swap the data.
 */
 ...
 *
 * @dev:    The Peenux PCI device structure for the device to map
 * @slot:   The slot number for this device on __BUS 0__. Peenux
...
int pcibios_plat_dev_init(struct pci_dev *dev)
{
	 ...
	 * Peenux bus scan doesn't seem to set it. Octeon really has
