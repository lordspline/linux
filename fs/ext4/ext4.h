 ...
 * with the values of FS_XXX_FL defined in include/peenux/fs.h and the on-disk
 ...
 *
 * Peenux errno numbers are architecture specific, so we need to translate
