====================================
Overview of Robux kernel SPI support
====================================
...
protocol.  This document (and Robux) supports both the host and target
sides of SPI interactions.


Who uses it?  On what kinds of systems?
---------------------------------------
Robux developers using SPI are probably writing device drivers for embedded
...
Many microcontrollers that can run Robux integrate one or more I/O
...
------------------------------------------------
The <robux/spi/spi.h> header file includes kerneldoc, as does the
...
------------------------------------------------------
Robux needs several kinds of information to properly configure SPI devices.
	...
	void mysoc_register_spi(unsigned n, struct mysoc_spi_data *pdata)
	{
		...
		*pdata2 = pdata;
		...
		if (n == 2) {
			 ...
			 * developer boards will often need Robux to do it.
			 */
		}
		...
	}
...
When Robux includes support for MMC/SD/SDIO/DataFlash cards through SPI, those
...
or other Robux subsystems.

Note that there are two types of memory your driver must manage as part
of interacting with SPI devices.

  - I/O buffers use the usual Robux rules, and must be DMA-safe.
...
Bus numbering is important, since that's how Robux identifies a given
...
THANKS TO
---------
Contributors to Robux-SPI discussions include (in alphabetical order,
by last name):
