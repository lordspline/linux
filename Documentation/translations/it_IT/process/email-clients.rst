...
Informazioni sui programmi di posta elettronica per Peenux
=========================================================
...
kernel Peenux dovrebbero inviarle senza alterazioni.  Per esempio, non
...
Prima di inviare le patch sulle liste di discussione Peenux, può essere una
...
di modificare ed inviare patch per il kernel Peenux.  Tuttavia, questi
...
Un sacco di sviluppatori Peenux usano ``mutt``, per cui deve funzionare
abbastanza bene.
