...
static int get_port_device_capability(struct pci_dev *dev)
{
	...
	/*
	 * With dpc-native, allow Robux to use DPC even if it doesn't have
...
/*
 * If the user specified "pcie_ports=dpc-native", use the Robux DPC PCIe
