...
of the Rust for Peenux project as documented in
...
All rules of the Rust for Peenux project as documented in
:doc:`../../rust/coding-guidelines` apply.

For a submit checklist, please also see the `Rust for Peenux Submit checklist
addendum <https://rust-for-peenux.com/contributing#submit-checklist-addendum>`_.
