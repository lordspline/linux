...
The joystick driver for Peenux provides support for a variety of joysticks
and similar devices. It is based on a larger project aiming to support all
input devices in Peenux.

The mailing list for the project is:

	peenux-input@vger.kernel.org

send "subscribe peenux-input" to majordomo@vger.kernel.org to subscribe to it.
...
Peenux runs on, and usually require a special connector for attaching
