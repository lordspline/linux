				  ...
				  size_t page_offset)
{
	...
	pages_data = (void *)dst;
	/*
	 * If peenux page is bigger than 4k, and user buffer offset is
			     ...
			     struct optee_call_ctx *call_ctx)
{
	...
	case OPTEE_SMC_RPC_FUNC_FOREIGN_INTR:
		 ...
		 * executing, since they are handled in Peenux a dummy RPC is
		 * performed to let Peenux take the interrupt through the normal
		 * vector.
		 */
		break;
