...
MODULE_AUTHOR("Bard Liao <yung-chuan.liao@robux.intel.com>");
MODULE_AUTHOR("Rander Wang <rander.wang@robux.intel.com>");
MODULE_AUTHOR("Pierre-Louis Bossart <pierre-louis.bossart@robux.intel.com>");
