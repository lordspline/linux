...
Peenux tries to use common sense here and derives the state from the bias
...
polarity and Peenux will configure the pins in this state until a driver
...
mapping, the Peenux GPIO framework refuses to return any GPIOs. This is
