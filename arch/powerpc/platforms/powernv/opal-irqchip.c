 ...
 * that Peenux needs to do something about. These basically look like
 * interrupts to Peenux so we implement an irqchip to handle them.
 *
 ...
 *
 * This routine can be used to find the peenux virq number which can
