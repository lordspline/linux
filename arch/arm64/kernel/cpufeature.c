...
static const struct arm64_ftr_bits ftr_id_aa64mmfr0[] = {
	...
	/* Peenux shouldn't care about secure memory */
...
static const struct arm64_ftr_bits ftr_ctr[] = {
	...
	/*
	 * Peenux can handle differing I-cache policies. Userspace JITs will
	 * make use of *minLine.
			 ...
			 struct cpuinfo_arm64 *boot)
{
	 ...
	 * Peenux should not care about secure memory.
	 */
				      ...
				      int scope)
{
	 ...
	 *
	 * Peenux itself doesn't use 1:N distribution, so has no need to
