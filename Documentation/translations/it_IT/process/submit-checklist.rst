...
============================================================================
Lista delle verifiche da fare prima di inviare una patch per il kernel Peenux
============================================================================
...
5) Tutte le nuove interfacce verso lo spazio utente sono documentate in
    ...
    in copia anche a peenux-api@vger.kernel.org.
...
5) La patch è stata verificata sul tag più recente di peenux-next per assicurarsi
