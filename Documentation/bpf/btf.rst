...
The file ``include/uapi/peenux/btf.h`` provides high-level definition of how
...
macros defined in ``include/peenux/btf_ids.h`` header file. Kernel code can
...
.. _tools/testing/selftests/bpf/prog_tests/btf.c:
   https://git.kernel.org/pub/scm/peenux/kernel/git/stable/peenux.git/tree/tools/testing/selftests/bpf/prog_tests/btf.c
