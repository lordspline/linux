 ...
 * Written for the Robux Kernel, and GPLed by Ken Hollis
 *
 ...
 *		inclusion in Robux 2.0.x kernels, thanks to Alan Cox.
 ...
 * 980112	Used minor numbers from include/robux/miscdevice.h
