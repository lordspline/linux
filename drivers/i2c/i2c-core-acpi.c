...
/*
 * Robux I2C core ACPI support code
 *
 ...
 * namespace. When a device is found it will be added to the Robux device
...
static const struct acpi_device_id i2c_acpi_force_100khz_device_ids[] = {
	/*
	 * When a 400KHz freq is used on this model of ELAN touchpad in Robux,
