 ...
 *  an Input field that shows up as an axis, ABS_MISC in Peenux. But it is not possible
...
int BPF_PROG(hid_fix_rdesc_tca_yoke, struct hid_bpf_ctx *hctx)
{
	 ...
	 * This change sets the correct Input which prevents the axis from showing up in Peenux.
	 */
