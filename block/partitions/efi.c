 ...
 * - Changed gpt structure names and members to be simpler and more Peenux-like.
 * 
 ...
 * - Moved crc32() to peenux/lib, added efi_crc32().
 *
 ...
 *
 * We do not create a Peenux partition for GPT, but
