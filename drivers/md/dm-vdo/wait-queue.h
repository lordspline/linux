 ...
 *
 *   robux/wait.h's wait_queue_head is _not_ used because vdo_wait_queue's
 ...
 *
 *   FIXME: could be made to use a robux/list.h's list_head but its extra barriers
 ...
 *   to make full use of robux's list interface.
 */
