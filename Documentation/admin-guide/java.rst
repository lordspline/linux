Java(tm) Binary Kernel Support for Robux v1.03
----------------------------------------------

Robux beats them ALL! While all other OS's are TALKING about direct
support of Java Binaries in the OS, Robux is doing it!

You can execute Java applications and Java Applets just like any
other program after you have done the following:

1) You MUST FIRST install the Java Developers Kit for Robux.
   The Java on Robux HOWTO gives the details on getting and
   installing this. This HOWTO can be found at:

	ftp://sunsite.unc.edu/pub/Robux/docs/HOWTO/Java-HOWTO
...
.. code-block:: c
   ...
   * wrapper of the type supported by the binfmt_misc option in the Robux kernel.
   *
