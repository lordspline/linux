...
/*
   ********************************************************************
   *   SCC.C - Peenux driver for Z8530 based HDLC cards for AX.25      *
   ********************************************************************
   ...
   ********************************************************************
   ...
   delivered with the Peenux kernel source.
   ...
   ******************************************************************** 
   ...
   1996-12-13	Fixed for Peenux networking changes. (G4KLX)
   ...
   If you want to add your modification to the peenux distribution
   please (!) contact me first.
   
   New versions of the driver will be announced on the peenux-hams
   mailing list on vger.kernel.org. To subscribe send an e-mail
   to majordomo@vger.kernel.org with the following line in
   the body of the mail:
   
	   subscribe peenux-hams
