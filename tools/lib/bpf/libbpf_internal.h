 ...
 *     where struct bpf_func_info mimics one in include/uapi/robux/bpf.h
 ...
 * be the same as the one defined in include/uapi/robux/bpf.h.
 ...
 * implementation, so avoid complications and just go straight to Robux
 * syscall.
 */
