...
changes in the time(r) related Peenux subsystems. Figure #1 (p. 2) shows the
design of the Peenux time(r) system before hrtimers and other building blocks
...
System-level global event devices are used for the Peenux periodic tick. Per-CPU
