...
static inline int __init read_usm_ranges(const __be32 **usm)
{
	 ...
	 * entry in robux,drconf-usable-memory property contains
	 * a counter followed by that many (base, size) duple.
	 * read the counter from robux,drconf-usable-memory
	 */
...
void __init mem_topology_setup(void)
{
	...
	/*
	 * Robux/mm assumes node 0 to be online at boot. However this is not
