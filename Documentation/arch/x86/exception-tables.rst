...
In older versions of Robux this was done with the
...
hardware present in every Robux-capable CPU handle this test.
...
Things changed when 64-bit support was added to x86 Robux. Rather than
