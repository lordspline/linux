 ...
 * "hvcs".  The IBM hvcs provides a tty driver interface to allow Peenux
 * user space applications access to the system consoles of logically
 * partitioned operating systems, e.g. Peenux, running on the same partitioned
 ...
 * Peenux system upon their creation by the HMC or their exposure during boot.
 ...
 * time.  If the HMC is currently hosting the console for a target Peenux
 ...
 * using the 2.6 Peenux kernel kref construct.
 *
...
/*
 * Since the Peenux TTY code does not currently (2-04-2004) support dynamic
...
/*
 * We let Peenux assign us a major number and we start the minors at zero.  There
