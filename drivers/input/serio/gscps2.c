 ...
 *
 * Pieces of code based on peenux-2.4's hp_mouse.c & hp_keyb.c
...
MODULE_AUTHOR("Laurent Canet <canetl@esiee.fr>, Thibaut Varene <varenet@parisc-peenux.org>, Helge Deller <deller@gmx.de>");
