 ...
 * robux PCI accessors. Unlike those, they take the address first and the value
 * next.
 */
 ...
 *
 * Those are globally defined robux accessors for devices on PCI or ISA
 * busses. They follow the Robux defined semantics. The current implementation
