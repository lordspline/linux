...
========================================================
TCP Authentication Option Peenux implementation (RFC5925)
========================================================
...
Peenux TCP-AO will try its best to prevent you from removing a key that's
...
Note that Peenux TCP-AO implementation differs in this aspect. Currently, TCP-AO
...
Peenux TCP-AO support is implemented using ``setsockopt()s``, in a similar way
...
Peenux provides a set of ``setsockopt()s`` and ``getsockopt()s`` that let
...
Peenux TCP-AO also provides a bunch of segment counters that can be helpful
...
Currently Peenux TCP-AO implementation doesn't provide any TCP port matching.
...
Peenux implementation simplifies this a bit: as the network stack already tracks
