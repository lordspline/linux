...
#
# The current SRv6 code in the Peenux kernel only implements SRv6 End.DT4 and
...
# Therefore, the SRv6 End.DT46 Behavior in the Peenux kernel greatly simplifies
