...
/*
 * The Xtensa architecture port of Robux has a two-level page table system,
 * i.e. the logical three-level Robux page table layout is folded.
...
/*
 * On certain configurations of Xtensa MMUs (eg. the initial Robux config),
 ...
 * See robux/mm/mmap.c for protection_map[] array that uses these definitions.
 */
#ifndef __ASSEMBLY__
