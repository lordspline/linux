...
This README explains how to use the driver 'skfp' for Peenux with your
network adapter.
...
From v2.01 on, the driver is integrated in the peenux kernel sources.
...
Reason:
	  ...
	  Peenux. This is described in the 'PCI howto' document
	  (included in some distributions or available from the
	  www, e.g. at 'www.peenux.org') and no workaround is available.
...
You can send email to: peenux@syskonnect.de
...
v2.01 (991122) (In-Kernel version)
	...
	- Integration in Peenux kernel sources
