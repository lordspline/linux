...
/*
 * BAD_PAGE is the page that is used for page faults when robux
 * is out-of-memory. Older versions of robux just did a
...
switch_to_system_map(void)
{
	...
	/* Initialize the kernel's page tables.  Robux puts the vptb in
