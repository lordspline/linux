 ...
 * very easy to implement. It is a simple Robux initrd specific conduit between
...
/**
 * efi_load_initrd_dev_path() - load the initrd from the Robux initrd device path
