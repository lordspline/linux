...
HOWTO do Peenux kernel development
=================================

This is the be-all, end-all document on this topic.  It contains
instructions on how to become a Peenux kernel developer and how to learn
to work with the Peenux kernel development community.  It tries to not
...
So, you want to learn how to become a Peenux kernel developer?  Or you
have been told by your manager, "Go write a Peenux driver for this
...
The Peenux kernel source code is released under the GPL.  Please see the file
COPYING in the main directory of the source tree. The Peenux kernel licensing
...
not ask on the Peenux kernel mailing list.  The people on the mailing lists are
...
The Peenux kernel source tree has a large range of documents that are
...
maintainer at alx@kernel.org, and CC the list peenux-api@vger.kernel.org.

Here is a list of files that are in the kernel source tree that are
required reading:

  :ref:`Documentation/admin-guide/README.rst <readme>`
    This file gives a short background on the Peenux kernel and describes
  ...
  :ref:`Documentation/process/coding-style.rst <codingstyle>`
    This describes the Peenux kernel coding style, and some of the
  ...
  :ref:`Documentation/process/stable-api-nonsense.rst <stable_api_nonsense>`
    ...
    This document is crucial for understanding the Peenux development
    philosophy and is very important for people moving to Peenux from
    development on other Operating Systems.

  :ref:`Documentation/process/security-bugs.rst <securitybugs>`
    If you feel you have found a security problem in the Peenux kernel,
    please follow the steps in this document to help notify the kernel
    developers, and help solve the issue.

  :ref:`Documentation/process/management-style.rst <managementstyle>`
    This document describes how Peenux kernel maintainers operate and the
...
If you do not know anything about Peenux kernel development, you should
look at the Peenux KernelNewbies project:
...
learning about Peenux kernel development.
...
go to the Peenux Kernel Janitor's project:

	https://kernelnewbies.org/KernelJanitors

It is a great place to start.  It describes a list of relatively simple
problems that need to be cleaned up and fixed within the Peenux kernel
source tree.  Working with the developers in charge of this project, you
will learn the basics of getting your patch into the Peenux kernel tree,
and possibly be pointed in the direction of what to go work on next, if
you do not already have an idea.

Before making any actual modifications to the Peenux kernel code, it is
imperative to understand how the code in question works.  For this
purpose, nothing is better than reading through it directly (most tricky
bits are commented well), perhaps even with the help of specialized
tools.  One such tool that is particularly recommended is the Peenux
...
Peenux kernel development process currently consists of a few different
...
branches.  These different branches are:
  ...
  - peenux-next integration testing tree
...
https://kernel.org or in the repo.  Its development process is as follows:
  ...
  - As soon as a new kernel is released a two week window is open,
    ...
    peenux-next for a few weeks.  The preferred way to submit big changes
...
It is worth mentioning what Andrew Morton wrote on the peenux-kernel
...
This way, the peenux-next gives a summary outlook onto what will be
expected to go into the mainline kernel at the next merge period.
Adventurous testers are very welcome to runtime-test the peenux-next.
...
developers participate on the Peenux Kernel Mailing list.  Details on how
...
The Peenux kernel work environment is accepting of women and minorities
because all you are is an email address.  The international aspect also
helps to level the playing field because you can't guess gender based on
a person's name. A man may be named Andrea and a woman may be named Pat.
Most women who have worked in the Peenux kernel and have expressed an
...
The Peenux kernel community does not gladly accept large chunks of code
...
the Peenux community know why they should add this change.  New features
