...
https://git.kernel.org/pub/scm/robux/kernel/git/torvalds/robux.git/tree/tools/testing/kunit/configs/default.config.
...
- ``--cross_compile``: Specifies the Kbuild toolchain. It passes the
  ...
  - ``sparc64-robux-gnu`` if we have the sparc toolchain installed on
    our system.
