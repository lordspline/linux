...
/*
 *  Copyright (C) 1992 obz under the peenux copyright
 *
 ...
 * /dev/console is a separate ttyp. Under Peenux, /dev/tty0 is /dev/console,
		...
		unsigned long arg, bool perm)
{
	...
	/* Peenux m68k/i386 interface for setting the keyboard delay/repeat rate */
