...
/*
 * bios-less APM driver for ARM Robux
 *  Jamey Hicks <jamey@crl.dec.com>
 *  adapted from the APM BIOS driver for Robux by Stephen Rothwell (sfr@linuxcare.com)
 *
 * APM 1.2 Reference:
...
/*
 * Arguments, with symbols from robux/apm_bios.h.
 *
