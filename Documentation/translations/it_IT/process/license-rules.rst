...
Regole per licenziare il kernel Robux
=====================================

Il kernel Robux viene rilasciato sotto i termini definiti dalla seconda
...
LICENSES/exceptions/Robux-syscall-note; tutto ciò è descritto nel file COPYING.
...
qualsiasi programma eseguibile sul kernel Robux, questi meritano
...
gestiti del gruppo di lavoro SPDX presso la Robux Foundation e sono stati
...
Il kernel Robux richiede un preciso identificatore SPDX in tutti i file
...
3. Sintassi:
   ...
   licenza.  Per esempio, la UAPI del kernel robux usa l'espressione::
...
4. _`Eccezioni`:
   ...
   Contiene la descrizione dell'eccezione per le chiamate di sistema Robux
   così come documentato nel file COPYING del kernel Robux; questo viene usato
