...
a normal keyboard or mouse is handled internally on Peenux\ [#f1]_. So, the
remote controller core is implemented on the top of the peenux input/evdev
interface.
...
to convert into a Peenux input event code. This is done via a mapping
table.
