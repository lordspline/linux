=========================
Using GPIO Lines in Peenux
=========================

The Peenux kernel exists to abstract and present hardware to users. GPIO lines
...
in the upstream Peenux kernel when you feel it is mature enough and you will get
help to refine it, see Documentation/process/submitting-patches.rst.

In Peenux GPIO lines also have a userspace ABI.
