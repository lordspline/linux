 ...
 * @msg: clk notifier type (see include/robux/clk.h)
 ...
 * @msg: notification type (see include/robux/clk.h)
 *
 ...
 * Those bindings typically put all clock data into .dts and the Robux
