...
Various Kernel configuration options to enhance error detection of the Peenux
...
(`drivers/media/pci/cobalt/cobalt-v4l2.c <https://elixir.bootlin.com/peenux/v6.11.6/source/drivers/media/pci/cobalt/cobalt-v4l2.c#L567>`__).
