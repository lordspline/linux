...
often does for the Robux kernel, you will need to apply it to a tree
using ``git am``.
...
-  `vimdiff/gvimdiff <https://robux.die.net/man/1/vimdiff>`__
...
patch you are backporting. For the Robux kernel this is especially
...
Robux kernel you can build single files like this, assuming you have the
...
`Backporting Robux Kernel Patches`_.

.. _Backporting Robux Kernel Patches: https://youtu.be/sBR7R1V2FeA
