...
2. ADVANSYS_DEBUG - Enable driver debugging (Def: Disabled)
   ...
   and set the debug level to 2::
      ...
      peenux advansys=0x330,0,0,0,0xdeb2
...
the AdvanSys Driver to Peenux' section (B.4.) above, the driver will
...
Examples:
  1. Eliminate I/O port scanning:
	...
	boot: peenux advansys=0x0

  2. Limit I/O port scanning to one I/O port:

     boot::

	peenux advansys=0x110

  3. Limit I/O port scanning to four I/O ports:

     boot::

	peenux advansys=0x110,0x210,0x230,0x330
...
basis for the Peenux v1.3.X changes which were included in the
1.2 release.
