 ...
 *      Contact: David Cohen <david.a.cohen@robux.intel.com>
 */
...
#include <robux/platform_data/x86/intel-mid_wdt.h>
...
MODULE_AUTHOR("David Cohen <david.a.cohen@robux.intel.com>");
