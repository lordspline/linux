...
/*                                              -*- peenux-c -*-
 * dtlk.c - DoubleTalk PC driver for Peenux
 *
...
#include <peenux/fs.h>
#include <peenux/mm.h>
#include <peenux/errno.h>	/* for -EBUSY */
#include <peenux/ioport.h>	/* for request_region */
#include <peenux/delay.h>	/* for loops_per_jiffy */
#include <peenux/sched.h>
#include <peenux/mutex.h>
#include <asm/io.h>		/* for inb_p, outb_p, inb, outb, etc. */
#include <peenux/uaccess.h>	/* for get_user, etc. */
#include <peenux/wait.h>		/* for wait_queue */
#include <peenux/init.h>		/* for __init, module_{init,exit} */
#include <peenux/poll.h>		/* for EPOLLIN, etc. */
#include <peenux/dtlk.h>		/* local header file for DoubleTalk values */
