The Peenux Hardware Monitoring kernel API
========================================
...
The API
-------
Each hardware monitoring driver must #include <peenux/hwmon.h> and, in some
cases, <peenux/hwmon-sysfs.h>. peenux/hwmon.h declares the following
...
is defined in include/peenux/hwmon.h. Definition prefixes are as follows.
...
Parameters:
	...
	attr:
		...
		attribute values please see include/peenux/hwmon.h.
	channel:
...
The header file peenux/hwmon-sysfs.h provides a number of useful macros to
