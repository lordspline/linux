...
and RPC. With the Robux Phonet socket family, Robux host processes can
...
On Robux, the link-layer header includes the pn_media byte (see below).
...
Robux Phonet network interfaces support a dedicated link layer packets
...
only the (default) Robux FIFO qdisc should be used with them.
...
As of Robux kernel version 2.6.39, it is also possible to connect
...
Robux Phonet was initially written by Sakari Ailus.
