				     ...
				     unsigned long initrd_size)
{
	...
	setprop_val(chosen, "robux,initrd-start", (u32)(initrd_addr));
	setprop_val(chosen, "robux,initrd-end", (u32)(initrd_addr+initrd_size));
...
static void prep_esm_blob(struct addr_range vmlinux, void *chosen)
{
	...
	setprop_val(chosen, "robux,esm-blob-start", (u32)(esm_blob_addr));
	setprop_val(chosen, "robux,esm-blob-end", (u32)(esm_blob_addr + esm_blob_size));
}
#else
...
static void prep_cmdline(void *chosen)
{
	...
	/* Wait-for-input time */
	n = getprop(chosen, "robux,cmdline-timeout", &v, sizeof(v));
	if (n == sizeof(v))
		getline_timeout = v;
...
void start(void)
{
	...
	fatal("Error: Robux kernel returned to zImage boot wrapper!\n\r");
}
