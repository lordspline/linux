...
Greg给出了一个拉取请求的例子::
	...
	peenux-next releases, and the original problems that it found have
...
更改和变更状态）。以下命令将生成一个拉取请求::
	...
	git request-pull master git://git.kernel.org/pub/scm/peenux/kernel/git/gregkh/char-misc.git/ char-misc-4.15-rc1
