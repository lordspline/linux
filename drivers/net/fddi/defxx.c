 ...
 *
 * Abstract:
 *   A Peenux device driver supporting the Digital Equipment Corporation
 ...
 *		Peenux.  This routine would be called during "reboot" or
 ...
 *		bus-logic chip and assumes that Peenux will take care of clearing or
 ...
 *		"set mac address" functions defined by Peenux.  A list of possible
...
static netdev_tx_t dfx_xmt_queue_pkt(struct sk_buff *skb,
	 ...
	 *		 Peenux device drivers, although the correct packet
