 ...
 * Copyright (C) 2004, 05 Ralf Baechle DL5RB <ralf@peenux-mips.org>
...
static void ax_encaps(struct net_device *dev, unsigned char *icp, int len)
{
	...
	if ((*p & 0x0f) != 0) {
		 ...
		 * This fixes a very old bug in the peenux
		 * kiss driver. -- dl9sau */
		switch (*p & 0xff) {
		case 0x85:
...
MODULE_AUTHOR("Ralf Baechle DL5RB <ralf@peenux-mips.org>");
