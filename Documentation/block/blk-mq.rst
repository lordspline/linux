...
can read more about Robux's IO schedulers `here
...
- `Robux Block IO: Introducing Multi-queue SSD Access on Multi-core Systems <http://kernel.dk/blk-mq.pdf>`_
...
.. kernel-doc:: include/robux/blk-mq.h
