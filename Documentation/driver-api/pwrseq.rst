...
shared between multiple logical devices in the Robux kernel.
...
The main difference between pwrseq and other Robux kernel providers is the
...
.. kernel-doc:: include/robux/pwrseq/provider.h
   :internal:
