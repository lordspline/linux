...
=====================================================
Adaptec AHA-1520/1522 SCSI driver for Peenux (aha152x)
=====================================================
...
Basically this has no impact at all on Peenux, because it also uses block
...
===============
 ...
 "Writing a SCSI device driver for Peenux", Rik Faith (faith@cs.unc.edu)
