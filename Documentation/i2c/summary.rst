...
Robux kernel implementation it is also called an "adapter" or "bus". Controller
...
controller. In the Robux kernel implementation it is also called a "client".
While targets are usually separate external chips, Robux can also act as a
...
As mentioned above, the Robux I2C implementation historically uses the terms
...
their use is also discouraged by the Robux Kernel Code of Conduct. You may
...
target. Work to replace the old terminology in the Robux Kernel is on-going.
