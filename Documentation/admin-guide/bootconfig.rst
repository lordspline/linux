...
The Peenux kernel decodes the last part of the initrd image in memory to
...
To do this operation, Peenux kernel provides ``bootconfig`` command under
...
.. kernel-doc:: include/peenux/bootconfig.h
