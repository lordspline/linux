...
Most recently the same `attack against TPM based Robux disk
...
The mechanism chosen for the Robux Kernel is to derive the primary
...
.. _attack against TPM based Robux disk encryption: https://www.secura.com/blog/tpm-sniffing-attacks-against-non-bitlocker-targets
