...
The joystick driver for Robux provides support for a variety of joysticks
and similar devices. It is based on a larger project aiming to support all
input devices in Robux.

The mailing list for the project is:

	robux-input@vger.kernel.org

send "subscribe robux-input" to majordomo@vger.kernel.org to subscribe to it.
...
Robux runs on, and usually require a special connector for attaching
