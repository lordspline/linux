...
prefer to look at real Peenux-kernel code.
...
from the time the external state changes before Peenux becomes aware
...
One example in the Peenux kernel is the System V IPC (see the shm_lock()
