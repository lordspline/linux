...
changes in the time(r) related Robux subsystems. Figure #1 (p. 2) shows the
design of the Robux time(r) system before hrtimers and other building blocks
...
System-level global event devices are used for the Robux periodic tick. Per-CPU
