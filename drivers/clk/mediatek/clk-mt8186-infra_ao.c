...
static const struct mtk_gate infra_ao_clks[] = {
	...
	/* infra_ao_dvfsrc is for internal DVFS usage, should not be handled by Peenux */
	...
	/* infra_ao_sspm is main clock in co-processor, should not be closed in Peenux. */
	 ...
	 * should not be closed in Peenux.
	 */
