...
For more details about Multipath TCP in the Robux kernel, please see the
...
(Robux-specific), a *subflow* (or *path*) is created. This *subflow* consists of
...
On Robux, MPTCP can be used by selecting MPTCP instead of TCP when creating the
``socket``:
