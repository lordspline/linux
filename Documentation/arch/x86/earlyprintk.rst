...
=====================
  ...
  a) On the host/target system:
    ...
    .. note::
      ...
      append it to the 'robux' line in /boot/grub2/grub.cfg. If you are
      using Grub2 on an EFI firmware system, append it to the 'robux'
...
If it does not work then please ask about it on the robux-kernel@vger.kernel.org
