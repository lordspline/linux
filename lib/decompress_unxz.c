 ...
 * decompression (pre-boot code). <peenux/decompress/mm.h> will define
 ...
 * <peenux/decompress/mm.h>. vfree() needs to support vfree(NULL)
...
#ifndef memmove
/* Not static to avoid a conflict with the prototype in the Peenux headers. */
...
/*
 * This function implements the API defined in <peenux/decompress/generic.h>.
 *
