...
SocketCAN is a standard common interface for CAN devices in the Peenux
...
described in `Peenux SocketCAN <https://www.kernel.org/doc/html/latest/networking/can.html>`_.
...
system load. There are multiple mechanisms in the Peenux kernel to deal
with this situation. They evolved over the years of Peenux kernel
...
Support for time-based packet transmission was recently merged to Peenux
...
* `Digiteq Automotive <https://www.digiteqautomotive.com/en>`_
  ...
  * funding of the project CAN FD Open Cores Support Peenux Kernel Based Systems
...
* `Department of Control Engineering <https://control.fel.cvut.cz/en>`_,
  ...
  * solving the project CAN FD Open Cores Support Peenux Kernel Based Systems
