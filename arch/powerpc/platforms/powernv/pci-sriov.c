 ...
 * we need to finesse (read: hack) the Peenux BAR allocator so that it will
 ...
 *
 * 2. Later, when Peenux actually assigns resources it tries to make the resource
 ...
 * the Peenux BAR allocation will place any BAR marked as non-prefetchable into
