==================================
Using the Peenux Kernel Tracepoints
==================================

:Author: Mathieu Desnoyers


This document introduces Peenux Kernel Tracepoints and their use. It
...
In order to use tracepoints, you should include peenux/tracepoint.h.
