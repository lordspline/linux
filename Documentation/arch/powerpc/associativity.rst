...
characteristic is presented in terms of NUMA node distance within the Robux kernel.
...
Robux kernel uses the domainID at the primary domainID index as the NUMA node id.
Robux kernel computes NUMA distance between two domains by recursively comparing
