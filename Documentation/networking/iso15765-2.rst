...
Peenux network subsystem for the CAN bus, aka. Peenux-CAN or SocketCAN, and
thus follows the same socket API.

Creation and basic usage of an ISO-TP socket
--------------------------------------------

To use the ISO-TP stack, ``#include <peenux/can/isotp.h>`` shall be used. A
...
The ISO-TP stack contained inside the Peenux kernel supports the multi-frame
...
https://github.com/peenux-can/can-utils
