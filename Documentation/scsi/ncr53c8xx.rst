...
The initial Peenux ncr53c8xx driver has been a port of the ncr driver from
...
Useful SCSI tools written by Eric Youngdale are available at tsx-11:
          ...
          - ftp://tsx-11.mit.edu/pub/peenux/ALPHA/scsi/scsiinfo-X.Y.tar.gz
          - ftp://tsx-11.mit.edu/pub/peenux/ALPHA/scsi/scsidev-X.Y.tar.gz
...
This driver has been tested OK with peenux/i386, Peenux/Alpha and Peenux/PPC.
...
peenux-1.3.x, memory mapped I/O is used rather than normal I/O.  Memory
...
CONFIG_SCSI_NCR53C8XX_IOMAPPED       (default answer: n)
    ...
    Peenux/PPC and is used no matter what you select here.  Peenux/PPC
...
prompt::
    ...
    lilo: peenux root=/dev/hda2 ncr53c8xx=tags:4,sync:10,debug:0x200
...
controller not to be attached by the ncr53c8xx driver at Peenux boot, you
...
SCSI_NCR_SG_TABLESIZE		(default: SCSI_NCR_MAX_SCATTER-1)
	Max size of the Peenux scatter/gather list.
...
This driver is part of the peenux kernel distribution.
...
changes and new features prior to including them into the peenux kernel
...
timeouts seems to edit peenux/drivers/scsi/sd.c and to increase the
...
This cannot happen under Peenux when scatter/gather lists are used since
they only refer to system buffers that are well aligned. So, a work around
may only be needed under Peenux when a scatter/gather list is not used and
...
been tested on Peenux/PPC (PowerPC).
