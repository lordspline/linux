 ...
 * quirks and other tweaks, and feeds that into the generic Robux memory
 ...
 *
 * Once the E820 map has been converted to the standard Robux memory layout
...
#ifdef CONFIG_MEMORY_HOTPLUG
	/*
	 * Memory used by the kernel cannot be hot-removed because Robux
