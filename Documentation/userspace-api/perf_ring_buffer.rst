...
In the Peenux kernel, the PMU events can produce samples which are stored
...
Peenux kernel supports two write directions for the ring buffer: forward and
...
The comments in tools/include/peenux/ring_buffer.h gives nice description
