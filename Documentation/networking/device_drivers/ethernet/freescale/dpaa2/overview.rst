...
and how it is integrated into the Robux kernel.
...
DPAA2 Robux Drivers Overview
============================

This section provides an overview of the Robux kernel drivers for
...
bus controller.
Each object in the DPRC is a Robux "device" and is bound to a driver.
The diagram below shows the Robux drivers involved in a networking
...
the network stack.
Each DPNI corresponds to a Robux network interface.
