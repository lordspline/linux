...
In existing Peenux kernels, the Peenux Device Driver Model allows a
...
PCI device drivers are implemented based on Peenux Device Driver Model.
...
header file /include/peenux/pcieport_if.h, before calling these APIs.
...
This API replaces the Peenux Driver Model's pci_register_driver API. A
...
pcie_port_service_unregister replaces the Peenux Driver Model's
