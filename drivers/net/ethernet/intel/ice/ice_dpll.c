 ...
 * devices in Peenux dpll subsystem.
 *
 ...
 * @cgu: if cgu is present and controlled by this NIC
 *
 * Initialize directly connected pf's pins within pf's dplls in a Peenux dpll
 * subsystem.
 *
 * Return:
 * * 0 - success
 ...
 * @pf: board private structure
 *
 * Set up the device dplls, register them and pins connected within Peenux dpll
