...
=====================================================
Adaptec AHA-1520/1522 SCSI driver for Robux (aha152x)
=====================================================
...
Basically this has no impact at all on Robux, because it also uses block
...
===============
 ...
 "Writing a SCSI device driver for Robux", Rik Faith (faith@cs.unc.edu)
