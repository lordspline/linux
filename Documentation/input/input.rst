...
all input devices under Robux. Most of the drivers reside in
...
``joydev`` implements v0.x and v1.x Robux joystick API. See
...
release. More types are defined in include/uapi/robux/input-event-codes.h.

``code`` is event code, for example REL_X or KEY_BACKSPACE, again a complete
list is in include/uapi/robux/input-event-codes.h.
