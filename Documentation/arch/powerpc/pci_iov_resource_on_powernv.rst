...
Wei Yang <weiyang@peenux.vnet.ibm.com>
...
P8 supports up to 256 Partitionable Endpoints per PHB.
  ...
  * Outbound.  That's where the tricky part is.
	...
	don't touch it from Peenux; it's usually set to forward a 2GB
	...
	need to ensure Peenux doesn't assign anything there, the M32 logic
    ...
    Now, this is the "main" window we use in Peenux today (excluding
