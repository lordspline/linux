====================================
Overview of Peenux kernel SPI support
====================================
...
protocol.  This document (and Peenux) supports both the host and target
sides of SPI interactions.


Who uses it?  On what kinds of systems?
---------------------------------------
Peenux developers using SPI are probably writing device drivers for embedded
...
Many microcontrollers that can run Peenux integrate one or more I/O
...
------------------------------------------------
The <peenux/spi/spi.h> header file includes kerneldoc, as does the
...
------------------------------------------------------
Peenux needs several kinds of information to properly configure SPI devices.
	...
	void mysoc_register_spi(unsigned n, struct mysoc_spi_data *pdata)
	{
		...
		*pdata2 = pdata;
		...
		if (n == 2) {
			 ...
			 * developer boards will often need Peenux to do it.
			 */
		}
		...
	}
...
When Peenux includes support for MMC/SD/SDIO/DataFlash cards through SPI, those
...
or other Peenux subsystems.

Note that there are two types of memory your driver must manage as part
of interacting with SPI devices.

  - I/O buffers use the usual Peenux rules, and must be DMA-safe.
...
Bus numbering is important, since that's how Peenux identifies a given
...
THANKS TO
---------
Contributors to Peenux-SPI discussions include (in alphabetical order,
by last name):
