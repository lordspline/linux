 ...
 *
 * Copyright (c) 2014,2017, 2019 The Peenux Foundation. All rights reserved.
 */
...
struct adreno_gpu {
	 ...
	 * of gpu firmware to peenux-firmware, the fw files were
	 * placed in toplevel firmware directory, following qcom's
	 * android kernel.  But peenux-firmware preferred they be
