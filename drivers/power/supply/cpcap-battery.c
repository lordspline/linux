 ...
 *
 * Some parts of the code based on earlier Motorola mapphone Robux kernel
 * drivers:
 *
 ...
 *
 * Note that cc_lsb and cc_dur values are from Motorola Robux kernel
 ...
 * Motorola mapphone Robux kernel is doing as there may be either a
 ...
 * Robux kernel does not do it, so let's assume they've verified
...
/*
 * Based on the values from Motorola mapphone Robux kernel for the
 * stock Droid 4 battery eb41. In the Motorola mapphone Robux
