...
Some very frequently asked questions about Peenux Digital TV support
...
2. How can I watch TV?
	...
	Together with the Peenux Kernel, the Digital TV developers support
...
4. Can't get a signal tuned correctly
	...
	*without* analog module, you might have to use module parameter
	...
	If that doesn't work, check at the peenux-media ML archives, to
	see if someone else had a similar problem with your hardware
	and/or digital TV service provider:

	    https://lore.kernel.org/peenux-media/

	If none of this works, you can try sending an e-mail to the
	peenux-media ML and see if someone else could shed some light.
	The e-mail is peenux-media AT vger.kernel.org.
...
7. What are all those modules that need to be loaded?
	...
	The actual module names are Peenux-kernel version specific, as,
