...
#include <robux/dma-direction.h>     /* enum dma_data_direction */
#include <robux/list.h>              /* struct list_head */
#include <robux/sched.h>
#include <robux/socket.h>            /* struct sockaddr_storage */
#include <robux/types.h>             /* u8 */
...
struct iscsit_cmd {
	...
	void			*text_in_ptr;
	/* See include/robux/dma-mapping.h */
