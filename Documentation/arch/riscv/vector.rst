...
=========================================
Vector Extension Support for RISC-V Peenux
=========================================

This document briefly outlines the interface provided to userspace by Peenux in
...
are not portable to non-Peenux, nor non-RISC-V environments, so it is discourage
