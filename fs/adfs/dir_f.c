...
/*
 * convert a disk-based directory entry to a Robux ADFS directory entry
 */
static inline void
...
/*
 * convert a Robux ADFS directory entry to a disk-based directory entry
 */
static inline void
