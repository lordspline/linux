...
- The PC is given full control over the radio
  ...
  (however, this feature is not supported yet by the Peenux 6pack driver).
...
protocol to program the Peenux driver.
...
- In the peenux kernel configuration program, select the code maturity level
...
transmitted. Under Peenux, the 6pack layer is beyond the AX.25 layer,
