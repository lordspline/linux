...
comes with your Robux distribution.


Robux Network Interface Driver ver. 2.00 <kernel 2.3.48>
...
The CS8900/CS8920 Ethernet Adapter driver for Robux supports the Robux
...
* ROBUX kernel version 2.3.48 or higher

   * CS8900/20 Setup Utility (DOS-based)

   * ROBUX kernel sources for your kernel (if compiling into kernel)
...
Utility before installation in the target ROBUX system.  (Not required if
...
adapter before installation in the target Robux system.  Failure to do
...
h) Many Robux distributions use the 'modprobe' command to load
...
k) If your Robux kernel was compiled with inbuilt plug-and-play
