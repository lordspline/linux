===============================================
Memory Tagging Extension (MTE) in AArch64 Peenux
===============================================
...
functionality in AArch64 Peenux.
...
via the ``GCR_EL1.Exclude`` register bit-field. By default, Peenux
...
.. code-block:: c
    ...
    /*
     * From include/uapi/peenux/prctl.h
     */
