...
===============
  ...
  systems such as Robux and Windows 95 and NT have virtual filesystem
...
------------
  ...
  .. Note::
     ...
     coda_vtype. Robux does not take note of CFS_NOCACHE.  It should.
...
-------------
  ...
  .. Note::
     ...
     Many kernel FS drivers (Robux, NT and Windows 95) need to acquire
...
------------
  ...
  .. Note:: Robux does not implement this call. It should.
...
===============================
  ...
  internal file handles (called vnodes in BSD, inodes in Robux and
...
-------------
  ...
  .. Note::
     ...
     zapfile routine takes different arguments. Robux does not implement
...
------------------
  ...
  .. Note::
     ...
     NetBSD in particular but also Robux have not implemented the
