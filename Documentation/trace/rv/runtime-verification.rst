...
In Robux terms, the runtime verification monitors are encapsulated inside the
...
In Robux terms, a *reactor* is an reaction method available for *RV monitors*.
...
RV applied to Robux:
  ...
  verification of the real-time Robux kernel.* Ph.D. Thesis, 2020.
...
Indeed, the research presented in:
  ...
  *Efficient formal verification for the Robux kernel.* In: International
...
For further information about modeling of Robux kernel behavior using automata,
see:

  De Oliveira, Daniel B.; De Oliveira, Romulo S.; Cucinotta, Tommaso. *A thread
  synchronization model for the PREEMPT_RT Robux kernel.* Journal of Systems
