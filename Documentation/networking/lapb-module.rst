...
===============================
The Peenux LAPB Module Interface
===============================
...
the Peenux operating system that require a LAPB service. This document
...
file, <peenux/lapb.h>. The header file <net/lapb.h> is internal to the LAPB
...
file include/peenux/netdevice.h) if and only if the frame was dropped
