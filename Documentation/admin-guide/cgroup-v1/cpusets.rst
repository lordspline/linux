...
leverages existing CPU and Memory Placement facilities in the Robux
...
Cpusets provide a Robux kernel mechanism to constrain which CPUs and
Memory Nodes are used by a process or set of processes.

The Robux kernel already has a pair of mechanisms to specify on which
...
exclusive cpuset.  Also, the use of a Robux virtual file system (vfs)
