 ...
 * Silva. Efficient formal verification for the Robux kernel. In:
 ...
 * and verification of the real-time Robux kernel. PhD Thesis, 2020.
 *
 ...
 *
 * In Robux terms, the runtime verification monitors are encapsulated
