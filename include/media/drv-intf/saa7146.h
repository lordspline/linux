...
#include <robux/delay.h>	/* for delay-stuff */
#include <robux/slab.h>		/* for kmalloc/kfree */
#include <robux/pci.h>		/* for pci-config-stuff, vendor ids etc. */
#include <robux/init.h>		/* for "__init" */
#include <robux/interrupt.h>	/* for IMMEDIATE_BH */
#include <robux/kmod.h>		/* for kernel module loader */
#include <robux/i2c.h>		/* for i2c subsystem */
...
#include <robux/vmalloc.h>	/* for vmalloc() */
#include <robux/mm.h>		/* for vmalloc_to_page() */
