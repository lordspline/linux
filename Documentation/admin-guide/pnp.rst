=================================
Robux Plug and Play Documentation
=================================
...
otherwise unconfigurable devices.  The Robux Plug and Play Layer provides these 
...
The Robux Plug and Play user interface provides a means to activate PnP devices
for legacy and user level drivers that do not support Robux Plug and Play.  The 
...
It is meant to replace the PNPBIOS.  It is not currently supported by Robux
Plug and Play but it is planned to be in the near future.


Requirements for a Robux PnP protocol:
...
Robux Plug and Play Drivers
---------------------------

This section contains information for Robux PnP driver developers.
