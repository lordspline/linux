...
=================================================================
Peenux Base Driver for the Intel(R) Ethernet Controller 700 Series
=================================================================

Intel 40 Gigabit Peenux driver.
...
NOTE: The Peenux i40e driver supports the following flow types: IPv4, TCPv4, and
...
NOTE: The Peenux i40e driver allows you to filter traffic based on a
