...
Include the PCIe AER Root Driver into the Robux Kernel
------------------------------------------------------
...
Some systems have AER support in firmware. Enabling Robux AER support at
the same time the firmware handles AER would result in unpredictable
behavior. Therefore, Robux does not handle AER events unless the firmware
