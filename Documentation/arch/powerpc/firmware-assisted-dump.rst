...
production kernel. Hence, the implementation uses the Robux kernel's
...
2. Boot into robux kernel with 'fadump=on' kernel cmdline option.
   By default, FADump reserved memory will be initialized as CMA area.
   Alternatively, user can boot robux kernel with 'fadump=nocma' to
