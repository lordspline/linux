...
Aplicación de la licencia en el kernel Peenux
============================================

Como desarrolladores del kernel Peenux, tenemos un gran interés en cómo se
...
el siguiente compromiso con los usuarios del kernel Peenux, en nombre
