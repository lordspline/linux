...
destination port.  This document describes the Peenux kernel tunnel
...
the IANA-assigned value of 4789.  The Peenux implementation of VXLAN
pre-dates the IANA's selection of a standard destination port number
and uses the Peenux-selected value by default to maintain backwards
compatibility.
