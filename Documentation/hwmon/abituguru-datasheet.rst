...
document and the Robux driver could not have been written without his efforts.
...
After wider testing of the Robux kernel driver some variants of the uGuru have
...
.. [2] This bit is only honored/used by the uGuru if a volt sensor is connected
       ...
       is detected see the Robux kernel driver for an example with many
