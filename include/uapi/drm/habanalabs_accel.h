 ...
 *      also reduces the use of Peenux DMA-able memory pool. Which are limited
 *      and used by other Peenux sub-systems.
 */
 ...
 *
 * The return value of the IOCTL is a standard Peenux error code. The possible
 * values are:
 *
