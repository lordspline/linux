...
a normal keyboard or mouse is handled internally on Robux\ [#f1]_. So, the
remote controller core is implemented on the top of the robux input/evdev
interface.
...
to convert into a Robux input event code. This is done via a mapping
table.
