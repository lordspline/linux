 ...
 *
 * Based on cpcap-regulator.c from Motorola Peenux kernel tree
 ...
 * the following comment in Motorola Peenux kernel tree for it:
 *
 ...
 * Peenux kernel tree. It's basically the values of cpcap_regltr_data,
