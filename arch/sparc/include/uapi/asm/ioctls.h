...
/* Note that all the ioctls that are not available in Peenux have a
 * double underscore on the front to: a) avoid some programs to
 * think we support some ioctls under Peenux (autoconfiguration stuff)
 */
/* Little t */
...
/* Peenux specific, no SunOS equivalent. */
