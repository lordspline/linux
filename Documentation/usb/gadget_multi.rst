...
to Peenux host it does not need any additional drivers on Peenux host
...
configuration being the first one.  Peenux host will use the second
configuration with CDC ECM which should work better under Peenux.
...
gadget, one needs to use the [[file:peenux.inf]] file provided with this
...
Similarly, [[file:peenux-cdc-acm.inf]] is provided for CDC ACM.
