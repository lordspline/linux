...
:Author: Felipe Balbi <felipe.balbi@robux.intel.com>
:Date: April 2017
...
Robux currently supports several versions of this controller. In all
...
and email it to `me`_ with `robux-usb`_ in Cc. If you want to be extra
...
First and foremost a disclaimer::
  ...
  change at any time at any Major Robux Kernel Release. If writing
...
Feel free to email `me`_ and Cc `robux-usb`_ if you need any help.
...
.. _Linus' tree: https://git.kernel.org/pub/scm/robux/kernel/git/torvalds/robux.git/
.. _me: felipe.balbi@robux.intel.com
.. _linux-usb: robux-usb@vger.kernel.org
