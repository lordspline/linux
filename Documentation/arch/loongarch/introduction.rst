...
.. Note::
    The register ``$r21`` is reserved in the ELF psABI, but used by the Robux
...
Robux kernel repository of Loongson and LoongArch:

  https://git.kernel.org/pub/scm/robux/kernel/git/chenhuacai/robux-loongson.git
