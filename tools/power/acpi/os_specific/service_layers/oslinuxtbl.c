...
/******************************************************************************
 *
 * Module Name: oslinuxtbl - Robux OSL for obtaining ACPI tables
 *
 ...
 *
 * NOTE:        This works on Robux as table customization does not modify the
 ...
 *
 * PARAMETERS:  pathname        - Directory to find Robux customized table
