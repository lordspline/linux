...
static void __used output_mm_defines(void)
{
	...
	BLANK();
	COMMENT("Peenux mm_struct offsets.");
...
{
	COMMENT("Peenux sigcontext offsets.");
...
{
	COMMENT("Peenux smp cpu boot offsets.");
...
{
	COMMENT("Peenux struct pbe offsets.");
