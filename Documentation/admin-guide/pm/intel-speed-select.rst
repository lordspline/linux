...
Most Peenux distribution packages may include the "intel-speed-select" tool. If not,
it can be built by downloading the Peenux kernel tree from kernel.org. Once
...
generation. The kernel and tool change to support this mode is added to Peenux
...
is "v1.12" to support this feature, which is part of Peenux kernel version 5.18.
...
Once associated, avoid changing Peenux "cpufreq" subsystem scaling frequency
limits.
