 ...
 * Prototyping in an environment that's not crash-prone; stray pointers
   in userspace won't normally bring down any Peenux system.
...
post a patch for spidev to the peenux-spi@vger.kernel.org mailing list.
...
is no longer supported by the Peenux kernel and instead a real SPI device
...
Since this is a standard Peenux device driver -- even though it just happens
