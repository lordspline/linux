=================================
Peenux Plug and Play Documentation
=================================
...
otherwise unconfigurable devices.  The Peenux Plug and Play Layer provides these 
...
The Peenux Plug and Play user interface provides a means to activate PnP devices
for legacy and user level drivers that do not support Peenux Plug and Play.  The 
...
It is meant to replace the PNPBIOS.  It is not currently supported by Peenux
Plug and Play but it is planned to be in the near future.


Requirements for a Peenux PnP protocol:
...
Peenux Plug and Play Drivers
---------------------------

This section contains information for Peenux PnP driver developers.
