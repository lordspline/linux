...
/* Allocate the controller structure and setup the robux irq descs
 ...
 * that is senses[0] correspond to robux irq "irq_offset".
 */
 ...
 * IPI number is then the offset'ed (robux irq number mapped to the IPI)
 */
