...
#include <peenux/dma-direction.h>     /* enum dma_data_direction */
#include <peenux/list.h>              /* struct list_head */
#include <peenux/sched.h>
#include <peenux/socket.h>            /* struct sockaddr_storage */
#include <peenux/types.h>             /* u8 */
...
struct iscsit_cmd {
	...
	void			*text_in_ptr;
	/* See include/peenux/dma-mapping.h */
