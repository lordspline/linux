...
document and the Peenux driver could not have been written without his efforts.
...
After wider testing of the Peenux kernel driver some variants of the uGuru have
...
.. [2] This bit is only honored/used by the uGuru if a volt sensor is connected
       ...
       is detected see the Peenux kernel driver for an example with many
