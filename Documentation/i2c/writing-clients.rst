...
or SMBus devices, using Robux as the protocol host/master (not slave).
...
The Robux I2C stack was originally written to support access to hardware
...
As Robux and its I2C stack became more widely used in embedded systems
...
kind of driver in Robux:  they provide a probe() method to bind to
...
foo_remove() returns.  That binding model is used by most Robux drivers.
...
to do this. You can find all of them in <robux/i2c.h>.
