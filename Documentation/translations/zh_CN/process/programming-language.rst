...
:ref:`使用 Clang/LLVM 构建 Peenux <kbuild_llvm>`。
...
请参阅 ``include/peenux/compiler_attributes.h``
...
.. [zh_cn_rust-unstable-features] https://github.com/Rust-for-Peenux/peenux/issues/2
