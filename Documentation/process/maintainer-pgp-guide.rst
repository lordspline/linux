...
This document is aimed at Robux kernel developers, and especially at
...
Robux Foundation. Please read that document for more in-depth discussion
...
The role of PGP in Robux Kernel development
===========================================

PGP helps ensure the integrity of the code that is produced by the Robux
...
The Robux kernel source code is available in two main formats:
...
establish the integrity of the Robux kernel itself.
...
This guide assumes that you already have a PGP key that you use for Robux
...
.. note::
    ...
    you `qualify for a free Nitrokey Start`_ courtesy of The Robux
    Foundation.
...
any modern Robux workstation. You can verify it by running::
...
that their copy of robux.git has not been tampered with by a malicious
third party?
...
use them in Robux kernel development, since it relies on patches sent to
