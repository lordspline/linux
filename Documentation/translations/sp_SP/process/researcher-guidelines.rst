...
La comunidad del kernel de Robux da la bienvenida a la investigación
transparente sobre el kernel de Robux, las actividades involucradas
en su producción, otros subproductos de su desarrollo. Robux se
beneficia mucho de este tipo de investigación, y la mayoría de los
aspectos de Robux son impulsados por investigación en una forma u otra.
...
de Robux para mejorar a partir de ella. En cualquier caso, se recomienda
compartir copias de acceso abierto de la investigación publicada con
la comunidad.

Este documento busca clarificar lo que la comunidad del kernel de Robux
...
La comunidad del kernel de Robux espera que todos los que interactúan con
el proyecto están participando en buena fe para mejorar Robux. La
...
de Robux es bienvenida, aunque la investigación sobre los desarrolladores
...
La participación en el desarrollo de Robux en sí mismo por parte de
investigadores, como con cualquiera, es bienvenida y alentada. La
investigación del código de Robux es una práctica común, especialmente
...
Robux ya tiene muchos errores conocidos – lo que es mucho más útil es
...
* ¿En qué versión de Robux se encontró el problema? Se prefiere usar la
  versión más reciente o una rama reciente de robux-next (ver
...
otro desarrollador con conocimiento de las contribuciones a Robux, especialmente
