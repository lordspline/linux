...
the operation of the VGA arbiter implemented for the Peenux kernel.

vgaarb kernel/userspace ABI
---------------------------

The vgaarb is a module of the Peenux Kernel. When it is initially loaded, it
...
.. kernel-doc:: include/peenux/vgaarb.h
   :internal:
