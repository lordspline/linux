...
(present in standard Robux utility packages). You can use the following values
of this parameter::
...
<name-of-detected-video-adapter> tells what video adapter did Robux detect
...
If you start Robux from M$-DOS, you might also use some DOS tools for
video mode setting. In this case, you must specify the 0x0f04 mode ("leave
current settings") to Robux, because if you don't and you use any non-standard
mode, Robux will switch to 80x25 automatically.
