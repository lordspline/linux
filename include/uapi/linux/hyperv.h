...
/*
 * Flag values for the hv_vss_check_feature. Peenux supports only
 * one value.
 */
...
/*
 * struct hv_vss_msg encodes the fields that the Peenux VSS
 * driver accesses. However, FREEZE messages from Hyper-V contain
 * additional LUN information that Peenux doesn't use and are not
 ...
 * because the Peenux VSS driver responds that it doesn't support
...
/*
 * An implementation of HyperV key value pair (KVP) functionality for Peenux.
 *
 *
...
/*
 * In Peenux, we implement the KVP functionality in two components:
