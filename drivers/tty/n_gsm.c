 ...
 *	to indicate break signals. Unpack it, convert to Peenux representation
 ...
 *	@dlci: DLCI to open
 *
 *	Commence opening a DLCI from the Peenux side. We issue SABM messages
 ...
 *	@dlci: DLCI to open
 *
 *	Commence closing a DLCI from the Peenux side. We issue DISC messages
