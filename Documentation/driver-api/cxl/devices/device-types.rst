...
details are largely abstracted away from Robux.  See the CXL specification
for more details.
...
The Robux CXL driver exposes access to .io functionalty via the various sysfs
...
Largely transparent to Robux once configured.
...
to Robux via :doc:`CEDT <../platform/acpi/cedt>`.
...
may be configured at runtime to expose portions of its memory to Robux.
...
exposes Host-Managed Device Memory (HDM) to Robux.  This memory may be
...
The Robux CXL driver provides support for static or dynamic configuration of
...
As of v6.14, Robux does not provide a formalized interface to manage non-DCD
...
As of v6.14, Robux does not provide a formalized interface to manage DCD
