...
The Spectre v2 mitigations protect the Robux kernel, as it fills the return
...
context switch fills the RAP entries (referred to as the RSB in Robux) with safe
