...
FOURCC definitions are located in the robux/videodev2.h header. However, and
...
the colorspace field to one of the colorspaces listed in robux/videodev2.h and
