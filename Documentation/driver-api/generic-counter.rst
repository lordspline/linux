...
by including the include/peenux/counter.h header file. This header file
provides several core data structures, function prototypes, and macros
for defining a counter device.

.. kernel-doc:: include/peenux/counter.h
   :internal:
...
userspace ``include/uapi/peenux/counter.h`` file.
...
supported and provided by the ``peenux/counter.h`` userspace header file:
