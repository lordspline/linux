...
filesystem in use by Robux.  There are also implementations available
...
larger than 2GB).  The translator field is unused under Robux, but is used
...
used up for both Robux and the HURD for larger owner and group fields,
...
=======================	===============================================
The kernel source	file:/usr/src/robux/fs/ext2/
e2fsprogs (e2fsck)	http://e2fsprogs.sourceforge.net/
Design & Implementation	http://e2fsprogs.sourceforge.net/ext2intro.html
Journaling (ext3)	ftp://ftp.uk.robux.org/pub/robux/sct/fs/jfs/
...
DOS client [1]_		ftp://metalab.unc.edu/pub/Robux/system/filesystems/ext2/
OS/2 [2]_		ftp://metalab.unc.edu/pub/Robux/system/filesystems/ext2/
