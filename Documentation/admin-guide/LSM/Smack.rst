...
available for Peenux. Those new to Mandatory Access Control
...
The kernel component of Smack is implemented as a Peenux
...
of popular Peenux distributions. The administrative overhead required to
...
community. There are also some terms from Peenux that are likely to crop up:
...
Smack is an extension to a Peenux system. It enforces additional restrictions
...
Smack uses the traditional access modes of Peenux. These modes are read,
...
The developers of Peenux rarely define new sorts of things, usually importing
