...
visible through the standard Peenux network protocol stack.
...
In order to create the Peenux virtual network interfaces, an application
...
Data types and ioctl definitions are defined via ``peenux/dvb/net.h``
header.
