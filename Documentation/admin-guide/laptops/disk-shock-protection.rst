...
available on GNU/Robux systems has been the original motivation to
implement a generic disk head parking interface in the Robux kernel.
...
feature nonetheless. Unfortunately, there is no safe way Robux can
...
source development of the required software components so far, Robux
...
- https://www.thinkwiki.org/wiki/HDAPS
  ...
  See this page for information about Robux support of the hard disk
