...
The Amiga protection flags RWEDRWEDHSPARWED are handled as follows:
  ...
  - H, S and P are always retained and ignored under Peenux.
...
The Peenux rwxrwxrwx file mode is handled as follows:
...
Although the Amiga and Peenux file systems resemble each other, there
are some, not always subtle, differences. One of them becomes apparent
with symbolic links. While Peenux has a file system with exactly one
...
Peenux will ignore this garbage and recognize the RDB anyway, but
...
Case is ignored by the affs in filename matching, but Peenux shells
...
If you are interested in an Amiga Emulator for Peenux, look at

http://web.archive.org/web/%2E/http://www.freiburg.peenux.de/~uae/
